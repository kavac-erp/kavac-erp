...
class DocumentStatusTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $this->command->line("");
        $this->command->info("<fg=yellow>Cargando los Estatus de Documentos</>");
        $this->command->line("");
        ...
        $this->command->info(
            ...
            "<fg=yellow> $this->count </><fg=green>Estatus de Documentos</>"
        );
        $this->command->line("");
        $this->command->info(
            "<fg=green>Se cargó y/o actualizó un total de</>" .
            "<fg=yellow> $this->countP </><fg=green>Permisos para la gestión de Estatus de Documentos</>"
        );
        $this->command->line("");
    }
}
