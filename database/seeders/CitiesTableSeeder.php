...
class CitiesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $this->command->line("");
        $this->command->info("<fg=yellow>Cargando las Ciudades</>");
        $this->command->line("");
        ...
        $this->command->info(
            "<fg=green>Se cargó y/o actualizó un total de</><fg=yellow> $this->count </><fg=green>Ciudades</>"
        );
        $this->command->line("");
        $this->command->info(
            "<fg=green>Se cargó y/o actualizó un total de</><fg=yellow> $this->countP </>" .
            "<fg=green>Permisos para la gestión de Ciudades</>"
        );
        $this->command->line("");
    }
}
