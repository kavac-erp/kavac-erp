...
class MunicipalitiesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $this->command->line("");
        $this->command->info("<fg=yellow>Cargando los Municipios</>");
        $this->command->line("");
        ...
        $this->command->info(
            "<fg=green>Se cargó y/o actualizó un total de</><fg=yellow> $this->count </><fg=green>Municipios</>"
        );
        $this->command->line("");
        $this->command->info(
            "<fg=green>Se cargó y/o actualizó un total de</><fg=yellow> $this->countP </>" .
            "<fg=green>Permisos para la gestión de Municipios</>"
        );
        $this->command->line("");
    }
}
