    ...
    public function run()
    {
        ...
        $permissions = array_merge($permissions, [
            [
                ...
                'description' => 'Acceso al registro de géneros',
                'model' => Gender::class, 'model_prefix' => '0general',
                'slug_alt' => 'gender.crear', 'short_description' => 'agregar género'
            ],
            [
                'name' => 'Editar Géneros', 'slug' => 'gender.edit',
                'description' => 'Acceso para editar géneros',
                'model' => Gender::class, 'model_prefix' => '0general',
                'slug_alt' => 'gender.editar', 'short_description' => 'editar género'
            ],
            [
                'name' => 'Eliminar Géneros', 'slug' => 'gender.delete',
                'description' => 'Acceso para eliminar géneros',
                'model' => Gender::class, 'model_prefix' => '0general',
                'slug_alt' => 'gender.eliminar', 'short_description' => 'eliminar género'
            ],
            [
                'name' => 'Ver Géneros', 'slug' => 'gender.list',
                'description' => 'Acceso para ver géneros',
                'model' => Gender::class, 'model_prefix' => '0general',
                'slug_alt' => 'gender.ver', 'short_description' => 'ver géneros'
            ],
            [
                'name' => 'Notificar gestión de Géneros',
                'slug' => 'gender.notify',
                'description' => 'Notificar sobre gestión de datos de géneros',
                'model' => Gender::class, 'model_prefix' => '0general',
                'slug_alt' => 'gender.notificar',
                'short_description' => 'notificar la gestión de géneros'
            ],
        ]);
        ...
        $permissions = array_merge($permissions, [
            [
                ...
                'description' => 'Acceso al registro de sedes',
                'model' => Headquarter::class, 'model_prefix' => '0general',
                'slug_alt' => 'headquarter.crear', 'short_description' => 'agregar sede'
            ],
            [
                'name' => 'Editar sedes', 'slug' => 'headquarter.edit',
                'description' => 'Acceso para editar sedes',
                'model' => Headquarter::class, 'model_prefix' => '0general',
                'slug_alt' => 'headquarter.editar', 'short_description' => 'editar sede'
            ],
            [
                'name' => 'Eliminar sedes', 'slug' => 'headquarter.delete',
                'description' => 'Acceso para eliminar sedes',
                'model' => Headquarter::class, 'model_prefix' => '0general',
                'slug_alt' => 'headquarter.eliminar', 'short_description' => 'eliminar sede'
            ],
            [
                'name' => 'Ver sedes', 'slug' => 'headquarter.list',
                'description' => 'Acceso para ver sedes',
                'model' => Headquarter::class, 'model_prefix' => '0general',
                'slug_alt' => 'headquarter.ver', 'short_description' => 'ver sedes'
            ],
        ]);
        ...
        $this->command->info(
            ...
            "<fg=green>Permisos Generalses del Sistema</>"
        );
        $this->command->line("");
    }
}
