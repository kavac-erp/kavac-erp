                ...
                <div id="helpConnectedLeyend">
                    <div class="row" id="helpConnectedUser">
                        <div class="col-md-4 panel-legend">
                            <i
                                class="fa fa-user text-success"
                                data-toggle="tooltip"
                                title="
                                    {{ __('Los usuarios con este estatus se encuentran conectados a la aplicación') }}
                                "
                            >
                            </i>
                        ...
                        @foreach(App\Models\User::all() as $user)
                            @php
                                ...
                                if (config('session.driver') === 'redis') {
                                    ...
                                    $session = $redis->get('session_user:'.$user->id);
                                    if (!is_null($session)) {
                                        $user_session = (object)json_decode($session, true);
                                    }
                                }
                            @endphp
                            <tr>
