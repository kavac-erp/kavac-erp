            ...
            <div class="row">
                <div class="col-md-2" id="helpScreenLockedActivated">
                    <div class="form-group">
                        {!! Form::label('lock_screen_label', __('Activar'), []) !!}
                        <div class="col-12">
                            <div class="bootstrap-switch-mini">
                                {!! Form::checkbox('lock_screen', true, auth()->user()->time_lock > 0, [
                                    'id' => 'lock_screen',
                ...
                <div class="col-md-2" id="helpScreenLockedTime">
                    <div class="form-group">
                        {!! Form::label('time_lock_label', __('Tiempo de inactividad en minutos'), []) !!}
                    ...
                    <div class="col-3 mb-4 collapse show" id="collapse{{ $section ?? 'GENERAL' }}">
                        <div class="form-group text-center">
                            ...
                            <div class="col-12 bootstrap-switch-mini">
                                ...
                                @php
                                    $switchEl = array_merge($switchEl, [
                                        $notifySetting->slug => $notifySetting->description,
                                    ]);
                                @endphp
                            </div>
                        </div>
