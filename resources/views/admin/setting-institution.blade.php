    ...
    <div id="card_config_institution" class="card">
        ...
        <div id="helpInstitutionImgs" class="row">
          <div class="col-md-4">
            <div class="form-group">
              ...
              @php
                $img_logo = isset($model_institution) && !is_null($model_institution->logo) && file_exists(base_path($model_institution->logo->url)) ? $model_institution->logo->url : null;
              @endphp
          ...
          <div class="col-md-8">
            <div class="form-group">
              ...
              @php
                $img_banner = isset($model_institution) && !is_null($model_institution->banner) && file_exists(base_path($model_institution->banner->url)) ? $model_institution->banner->url : null;
              @endphp
              <img src="{{ asset($img_banner ?? 'images/no-image3.png') }}" alt="{{ __('Banner / Cintillo') }}"
      ...
      <div class="card-body">
            ...
            <div class="col-md-4" id="helpInstitutionRif">
              <div class="form-group{{ $errors->has('rif') ? ' has-error' : '' }} is-required">
                ...
                {!! Form::text('rif', isset($model_institution) ? $model_institution->rif : old('rif'), [
                    ...
                    'title' => __('Indique el número de registro de identificación fiscal (requerido). Debe estar formado por 10 caracteres, el primer carácter debe ser una letra: J,V,E,G o P (en mayúscula); los otros nueve carácteres deben ser números.'),
                ]) !!}
              </div>
            </div>
            <div class="col-md-4">
        ...
        <div class="form-group">
         ...
         {!! Form::select('organism_adscript_id', isset($organism_adscripts) ? $organism_adscripts : [], null, [
             'class' => 'form-control select2',
             'id' => 'organism_adscript_id',
         ]) !!}
        </div>
       </div> -->
              ...
              <div class="form-group is-required">
                ...
                <div id="legal_address_editor">
                  <ckeditor :editor="ckeditor.editor" id="legal_address" data-toggle="tooltip"
                    title="{!! __('Indique la dirección fiscal de la organización (requerido)') !!}" :config="ckeditor.editorConfig" class="form-control"
                    name="legal_address" tag-name="textarea" rows="4" value="{!! isset($model_institution) ? $model_institution->legal_address : old('legal_address') !!}">
                  </ckeditor>
                </div>
              </div>
            </div>
                    ...
                    <div class="custom-control custom-switch" data-toggle="tooltip"
                      ...
                      {!! Form::checkbox(
                          ...
                          [
                              ...
                              'disabled' => ((isset($canDesactivate) && !$canDesactivate && isset($model_institution) && $model_institution->default && $model_institution->active))
                          ],
                      ) !!}
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <ckeditor :editor="ckeditor.editor" id="legal_base" data-toggle="tooltip"
                  title="{!! __('Indique la base legal constitutiva de la organización') !!}" :config="ckeditor.editorConfig" class="form-control"
                  name="legal_base" tag-name="textarea" rows="4" value="{!! isset($model_institution) ? $model_institution->legal_base : old('legal_base') !!}"></ckeditor>
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                ...
                <ckeditor :editor="ckeditor.editor" id="legal_form" data-toggle="tooltip"
                  title="{!! __('Indique la forma jurídica de la organización') !!}" :config="ckeditor.editorConfig" class="form-control"
                  name="legal_form" tag-name="textarea" rows="4" value="{!! isset($model_institution) ? $model_institution->legal_form : old('legal_form') !!}"></ckeditor>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <ckeditor :editor="ckeditor.editor" id="main_activity" data-toggle="tooltip"
                  title="{!! __('Indique la actividad principal a la cual se dedica la organización') !!}" :config="ckeditor.editorConfig" class="form-control"
                  name="main_activity" tag-name="textarea" rows="4" value="{!! isset($model_institution) ? $model_institution->main_activity : old('main_activity') !!}">
                </ckeditor>
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                ...
                <ckeditor :editor="ckeditor.editor" id="mission" data-toggle="tooltip"
                  title="{!! __('Indique la misión de la organización') !!}" :config="ckeditor.editorConfig" class="form-control"
                  name="mission" tag-name="textarea" rows="4" value="{!! isset($model_institution) ? $model_institution->mission : old('mission') !!}"></ckeditor>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <ckeditor :editor="ckeditor.editor" id="vision" data-toggle="tooltip"
                  title="{!! __('Indique la visión de la organización') !!}" :config="ckeditor.editorConfig" class="form-control"
                  name="vision" tag-name="textarea" rows="4" value="{!! isset($model_institution) ? $model_institution->vision : old('vision') !!}"></ckeditor>
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                ...
                <ckeditor :editor="ckeditor.editor" id="composition_assets" data-toggle="tooltip"
                  title="{!! __('Indique la composición patrimonial de la organización') !!}" :config="ckeditor.editorConfig" class="form-control"
                  name="composition_assets" tag-name="textarea" rows="4" value="{!! isset($model_institution) ? $model_institution->composition_assets : old('composition_assets') !!}">
                </ckeditor>
              </div>
            </div>
          </div>
        ...
        <div class="row">
          <!-- Ocultando temporalmente el boton para agreagr nuevas empresas -->
          @if(false)
          <div class="col-12 text-right">
            @include('buttons.new', [
                'route' => 'javascript:void(0)',
                'btnClass' => 'btn btn-sm btn-primary btn-custom btn-mini btn-new btn-new-institution',
            ])
          </div>
          @endif
        </div>

        <table class="table table-hover table-striped dt-responsive nowrap datatable" id="helpInstitutionList">
          <thead>
            <tr>
              ...
              <tr>
                <td class="text-center">
                  @if (!is_null($institution->logo))
                    <img src="{{ url($institution->logo->url) }}" alt="{{ __('logo') }}" class="img-fluid"
                ...
                <td class="text-center">
                  <a class="btn btn-info btn-xs btn-icon btn-action" data-toggle="tooltip" href="javascript:void(0)"
                    title="Ver registro" v-has-tooltip onclick="showInstitution('{{ $institution->id }}')">
                    <i class="fa fa-eye"></i>
                  </a>
    ...
    var loadInstitution = function(id) {
      ...
      axios.get(`get-institution/details/${id}`).then(response => {
        if (response.data.result) {
          ...
          getselect($("#country_id"), institution.municipality.estate.country.id, institution.municipality.estate
            .id, $("#estate_id"), "Estate");
