...
if (window.auth) {
    ...
    axios
        .get("/get-execution-year", {})
        .then((response) => {
            if (response.data.result) {
                window.execution_year = response.data.year;
                let fiscalYear = document.querySelector(".fiscal-year");
                if (fiscalYear) {
                    fiscalYear.innerText = window.execution_year;
                }
            }
        })
        .catch((error) => {
            ...
            if (window.debug) {
                console.error(
                    "Se ha generado un error con la siguiente información:",
                    p
                );
                console.trace();
            }
 ...
 */
Vue.component("formula-calculator", () =>
    import(
        /* webpackChunkName: "formula-calculator" */
        "./components/Shared/FormulaCalculatorComponent.vue"
    )
);
 ...
 * @author Ing. Roldan Vargas <rvargas@cenditel.gob.ve> | <roldandvg@gmail.com>
 */
Vue.component("lock-screen-option", () =>
    import(
 ...
 * @author Ing. Roldan Vargas <rvargas@cenditel.gob.ve> | <roldandvg@gmail.com>
 */
Vue.component("modal-form-buttons", () =>
    import(
 ...
 * @author  Ing. Roldan Vargas <rvargas@cenditel.gob.ve> | <roldandvg@gmail.com>
 */
Vue.component("image-management", () =>
    import(
 ...
 * @author Ing. Roldan Vargas (rvargas@cenditel.gob.ve / roldandvg@gmail.com)
 */
Vue.component("roles-permissions", () =>
    import(
 ...
 * @author Ing. Roldan Vargas (rvargas@cenditel.gob.ve / roldandvg@gmail.com)
 */
Vue.component("required-documents", () =>
    import(
 ...
 * @author  Ing. Roldan Vargas <rvargas@cenditel.gob.ve> | <roldandvg@gmail.com>
 */
Vue.component("document-management", () =>
    import(
...
Vue.component("send-custom-messages", () =>
    import(
        /* webpackChunkName: "send-messages" */
        "./components/Shared/SendCustomNotificationsComponent.vue"
    )
);
Vue.component("shared-quatation-list", () =>
    import(
        /* webpackChunkName: "send-messages" */
        "./components/Shared/QuotationSharedListComponent.vue"
    )
);
Vue.component("shared-budgetary-availability-show", () =>
    import(
        /* webpackChunkName: "send-messages" */
        "./components/Shared/BudgetaryAvailabilityShowComponent.vue"
    )
);

Vue.component("send-notifications", () =>
    import(
 ...
 * @author Ing. Roldan Vargas (rvargas@cenditel.gob.ve / roldandvg@gmail.com)
 */
Vue.component("all-notifications", () =>
    import(
...
/**
 * Componente para la asignación de roles y permisos de acceso a usuarios
 *
 * @author     Ing. Roldan Vargas <rvargas@cenditel.gob.ve> | <roldandvg@gmail.com>
 */
Vue.component("user-roles-permissions", () =>
    import(
        /* webpackChunkName: "user-roles-permissions" */
        "./components/Admins/UserRolesPermissionsComponent.vue"
    )
);
 ...
 * @author     Ing. Roldan Vargas <rvargas@cenditel.gob.ve> | <roldandvg@gmail.com>
 */
Vue.component("close-fiscal-years", () =>
    import(
        /* webpackChunkName: "close-fiscal-years" */
        "./components/CloseFiscalYear/CloseFiscalYearSearchComponent.vue"
    )
);

/**
 * Componente para registrar cierre de ejercicio fiscal
 *
 * @author     Daniel Contreras <dcontreras@cenditel.gob.ve> | <exodiadaniel@gmail.com>
 */
Vue.component("close-fiscal-years-create", () =>
    import(
        /* webpackChunkName: "close-fiscal-years-create" */
        "./components/CloseFiscalYear/CloseFiscalYearCreateComponent.vue"
    )
);
 ...
 * @author     Daniel Contreras <dcontreras@cenditel.gob.ve> | <exodiadaniel@gmail.com>
 */
Vue.component("close-fiscal-years-list", () =>
    import(
        /* webpackChunkName: "close-fiscal-years-list" */
        "./components/CloseFiscalYear/CloseFiscalYearListComponent.vue"
    )
);
 ...
 * @author     Daniel Contreras <dcontreras@cenditel.gob.ve> | <exodiadaniel@gmail.com>
 */
Vue.component("close-fiscal-year-info", () =>
    import(
        /* webpackChunkName: "close-fiscal-year-info" */
        "./components/CloseFiscalYear/CloseFiscalYearInfoComponent.vue"
    )
);

/**
 * Componente para registrar la cuenta a utilizar para el cierre del ejercicio fiscal
 *
 * @author     Daniel Contreras <dcontreras@cenditel.gob.ve> | <exodiadaniel@gmail.com>
 */
Vue.component("close-fiscal-years-account", () =>
    import(
        /* webpackChunkName: "close-fiscal-years-account" */
        "./components/CloseFiscalYear/Settings/CloseFiscalYearAccountSettingComponent.vue"
    )
);
 ...
 * @author  Ing. Roldan Vargas <rvargas@cenditel.gob.ve> | <roldandvg@gmail.com>
 */
Vue.component("institution-types", () =>
    import(
 ...
 * @author  Ing. Roldan Vargas <rvargas@cenditel.gob.ve> | <roldandvg@gmail.com>
 */
Vue.component("institution-sectors", () =>
    import(
 ...
 * @author Ing. Roldan Vargas (rvargas@cenditel.gob.ve / roldandvg@gmail.com)
 */
Vue.component("measurement-units", () =>
    import(
...
/**
 * Componente para la configuración y gestión de sedes
 *
 * @author  Daniel Contreras <dcontreras@cenditel.gob.ve> | <exodiadaniel@gmail.com>
 */
Vue.component("headquarters", () =>
    import(
        /* webpackChunkName: "headquarters" */
        "./components/Settings/HeadquartersComponent.vue"
    )
);
 ...
 */
Vue.component("genders", () =>
    import(
        /* webpackChunkName: "genders" */
        "./components/Settings/GendersComponent.vue"
    )
);

/**
 * Componente para el uso de tablas con columnas arrastrables
 *
 * @author  Henry Paredes <hparedes@cenditel.gob.ve> | <henryp2804@gmail.com>
 */
Vue.component("v-draggable-table", () =>
    import(
        /* webpackChunkName: "draggable-table" */
        "./components/Shared/DraggableTableComponent.vue"
    )
);

Vue.component("v-custom-multiselect", () =>
    import(
        /* webpackChunkName: "custom-multiselect" */
        "./components/Shared/CustomMultiSelectComponent.vue"
    )
);