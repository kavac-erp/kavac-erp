<template>
	<section class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-2 mt-2 mb-2 text-center"  id="payroll_gender">
		<a class="btn-simplex btn-simplex-md btn-simplex-primary" href=""
		   title="Registros de géneros" data-toggle="tooltip"
		   @click="addRecord('add_gender', 'genders', $event)">
...
<script>
	export default {
		...
		mounted () {
			const vm = this;
			$("#add_gender").on('show.bs.modal', function() {
                vm.reset();
            });
		},
	};
