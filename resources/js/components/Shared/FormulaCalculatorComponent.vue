<template>
    <div class="formula-calculator">
        <div v-if="withDisplay" class="form-group" :class="(requiredClass) ? 'is-required' : ''">
            <label>Fórmula</label>
            <input 
                ...
                readonly
                v-model="$parent.record[formulaInput]"
            >
        </div>
        <div class="form-group row">
            <div class="col-12 col-md-8 text-center mx-auto">
                ...
                <button 
                    type="button" class="btn btn-info btn-sm btn-formula btn-plus" data-toggle="tooltip" 
                    title="presione para agregar el signo de suma" @click="setFormula('+')"
                >
                    +
                </button>
                <button 
                    type="button" class="btn btn-info btn-sm btn-formula btn-backspace" data-toggle="tooltip" 
        ...
        <div class="form-group row">
            <div class="col-12 col-md-8 text-center mx-auto">
                ...
                <button 
                    type="button" class="btn btn-info btn-sm btn-formula btn-minus" data-toggle="tooltip" 
                    title="presione para agregar el signo de resta" @click="setFormula('-')"
                >
                    -
                </button>
                <button 
                    type="button" class="btn btn-info btn-sm btn-formula btn-start-parenthesis" data-toggle="tooltip" 
        ...
        <div class="form-group row">
            <div class="col-12 col-md-8 text-center mx-auto">
                ...
                <button 
                    type="button" class="btn btn-info btn-sm btn-formula btn-asterisk" data-toggle="tooltip" 
                    title="presione para agregar el signo de multiplicación" @click="setFormula('*')"
                >
                    *
                </button>
                <button 
                    type="button" class="btn btn-info btn-sm btn-formula btn-end-parenthesis" data-toggle="tooltip" 
        ...
        <div class="form-group row">
            <div class="col-12 col-md-8 text-center mx-auto">
                <button 
                    type="button" class="btn btn-info btn-sm btn-formula btn-clear" data-toggle="tooltip" 
                ...
                <button 
                    type="button" class="btn btn-info btn-sm btn-formula btn-division" data-toggle="tooltip" 
                    title="presione para agregar el signo de división" @click="setFormula('/')"
                >
                    /
                </button>
                <!--<button 
                    type="button" class="btn btn-info btn-sm btn-formula btn-percent" data-toggle="tooltip" 
                    title="presione para agregar el signo de porcentaje" style="padding-right:12px;padding-left:12px;" 
                    @click="setFormula('%')"
                >
                    %
                </button>-->
        ...
        <div class="form-group row" v-if="withAmountButton">
            <div class="col-12 offset-sm-2 col-md-7 col-btn-block text-center">
                <button 
                    type="button" class="btn btn-info btn-sm btn-formula btn-amount" data-toggle="tooltip" 
