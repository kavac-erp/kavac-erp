...
class TechnicalSupportRoleAndPermissionsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $permissions = [
            ...
            */
            [
                'name'              => 'Vista principal del dashboard del módulo de soporte técnico',
                'slug'              => 'technicalsupport.dashboard',
                'description'       => 'Acceso para visualizar el dashboard del módulo',
                'model'             => '',
                'model_prefix'      => 'soporte técnico',
                'slug_alt'          => 'panel_de_control.ver',
                'short_description' => 'Visualizar panel de control del módulo de soporte técnico'
            ],
        ];
