<template>
    <div class="text-center">
        <a class="btn-simplex btn-simplex-md btn-simplex-primary"
            href="#" title="Registros de servicios"
            data-toggle="tooltip"
            @click="addRecord( 'add_services', '/purchase/services', $event)">
            <i class="ion icofont icofont-pay ico-3x"></i>
            <span>Servicios</span>
        </a>
        <div class="modal fade text-left" tabindex="-1" role="dialog" id="add_services">
                ...
                <div class="modal-content">
                            ...
                            <div class="col-md-6">
                                <div class="form-group is-required">
                                    ...
                                    <input type="text" placeholder="Nombre del servicio"
                                           ...
                                           title="Indique el nombre del servicio (requerido)"
                            ...
                            <div class="col-6">
                                <div class="form-group is-required">
                                    ...
                                    <ckeditor :editor="ckeditor.editor" id="description"
                                              data-toggle="tooltip"
                                              title="Indique la descripcion del servicio"
                    ...
                    <div class="modal-footer">
                        <div class="form-group">
                            ...
                            <button type="button"
                                    @click="createRecord('purchase/services')"
                    ...
                    <div class="modal-body modal-table">
                        <v-client-table :columns="columns" :data="records" :options="table_options">
                            ...
                            <div slot="id" slot-scope="props" class="text-center">
                                ...
                                <button @click="deleteRecord(props.row.id, '/purchase/services')"
