<template>
    <div class="text-center">
        <a class="btn-simplex btn-simplex-md btn-simplex-primary" href="#" title="Registros de tipos de proveedores" data-toggle="tooltip" v-has-tooltip @click="addRecord('add_type', '/purchase/supplier-types', $event)">
                    ...
                    <div class="modal-body modal-table">
                        <v-client-table :columns="columns" :data="records" :options="table_options">
                            <div slot="id" slot-scope="props" class="text-center">
                                ...
                                <button @click="deleteRecord(props.row.id, '/purchase/supplier-types')" class="btn btn-danger btn-xs btn-icon btn-action" title="Eliminar registro" data-toggle="tooltip" v-has-tooltip type="button">
