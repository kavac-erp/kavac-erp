                ...
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        ...
                        <h6>
                            ...
                            Presupuesto base - Información del requerimiento
                        </h6>
                    </div>
                    <!-- Final modal-header -->
                    <!-- modal-body -->
                    <div class="modal-body">
                        ...
                        >
                            <div
                                ...
                                class="text-center"
                            >
                                <div v-if="props.row.purchase_supplier_object &&
                                    props.row.purchase_supplier_object
                                        .name
                                    ">
                                    <strong v-if="props.row.purchase_supplier_object
                                            .type == 'B'
                                        "
                                    >
                                        Bienes
                                    </strong>
                                    <strong v-else-if="props.row.purchase_supplier_object
                                            .type == 'O'
                                        "
                                    >
                                        Obras
                        ...
                        <div v-if="records.availabilityitem != ''">
                            <h6 class="card-title text-center">
                                Cuentas presupuestarias de gastos
                            </h6>
                            <table class="table">
                        ...
                        <div class="row">
                            <div class="col-3">
                                ...
                                {{
                                    ...
                                    && records.purchase_requirement.prepared_by
                                    ? records.purchase_requirement.prepared_by.payroll_staff
                                    ? records.purchase_requirement.prepared_by.payroll_staff.first_name + " " +
                                        records.purchase_requirement.prepared_by.payroll_staff.last_name
                                    : "No definido"
                                    : records.prepared_by
                                    ? records.prepared_by.payroll_staff
                                    ? records.prepared_by.payroll_staff.first_name + " " +
                                        records.prepared_by.payroll_staff.last_name
                                    : "No definido"
                                    : "No definido"
                                }}
                            </div>
                            <div class="col-3">
                                ...
                                {{
                                    records.purchase_requirement
                                    && records.purchase_requirement.reviewed_by
                                    ? records.purchase_requirement.reviewed_by.payroll_staff
                                    ? records.purchase_requirement.reviewed_by.payroll_staff.first_name + " " +
                                        records.purchase_requirement.reviewed_by.payroll_staff.last_name
                                    : "No definido"
                                    : records.reviewed_by
                                    ? records.reviewed_by.payroll_staff
                                    ? records.reviewed_by.payroll_staff.first_name + " " +
                                        records.reviewed_by.payroll_staff.last_name
                                    : "No definido"
                                    : "No definido"
                                }}
                            </div>
                            <div class="col-3">
                                ...
                                {{
                                    records.purchase_requirement
                                    && records.purchase_requirement.verified_by
                                    ? records.purchase_requirement.verified_by.payroll_staff
                                    ? records.purchase_requirement.verified_by.payroll_staff.first_name + " " +
                                        records.purchase_requirement.verified_by.payroll_staff.last_name
                                    : "No definido"
                                    : records.verified_by
                                    ? records.verified_by.payroll_staff
                                    ? records.verified_by.payroll_staff.first_name + " " +
                                        records.verified_by.payroll_staff.last_name
                                    : "No definido"
                                    : "No definido"
                                }}
                            </div>
                            <div class="col-3">
                                ...
                                {{
                                    records.purchase_requirement
                                    && records.purchase_requirement.first_signature
                                    ? records.purchase_requirement.first_signature.payroll_staff
                                    ? records.purchase_requirement.first_signature.payroll_staff.first_name + " " +
                                        records.purchase_requirement.first_signature.payroll_staff.last_name
                                    : "No definido"
                                    : records.first_signature
                                    ? records.first_signature.payroll_staff
                                    ? records.first_signature.payroll_staff.first_name + " " +
                                        records.first_signature.payroll_staff.last_name
                                    : "No definido"
                                    : "No definido"
                                }}
                            </div>
                            <div class="col-3">
                                ...
                                {{
                                    ...
                                    ? records.purchase_requirement.second_signature.payroll_staff.first_name + " " +
                                        records.purchase_requirement.second_signature.payroll_staff.last_name
                                    : "No definido"
                                    : records.second_signature
                                    ? records.second_signature.payroll_staff
                                    ? records.second_signature.payroll_staff.first_name + " " +
                                        records.second_signature.payroll_staff.last_name
                                    : "No definido"
                                    : "No definido"
                                }}
                            </div>
            ...
            if (this.records.relatable) {
                for (var i = 0; i < this.records.relatable.length; i++) {
                    if (this.records.relatable[i].purchase_requirement_item) {
                        var item = this.records.relatable[i]
                        ...
                        item.tax_percentage = this.records.relatable[i]
                            ...
                            ? this.records.relatable[i]
                                .purchase_requirement_item.history_tax.percentage
                            : 0.0;
                        item.requirement_code = this.records.relatable[
                            i
