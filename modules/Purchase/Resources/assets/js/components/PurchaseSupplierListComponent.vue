        ...
        <v-client-table :columns="columns" :data="records" :options="table_options">
            ...
            <div slot="id" slot-scope="props" class="text-center">
                <div class="d-inline-flex">
                    <purchase-suppliers-show
                        :id="props.row.id"
                        :route_show="'/purchase/suppliers/'+props.row.id"
                    />
                    <button
...
export default {
    ...
    methods: {
        ...
        DataMigratePivote() {
            ...
            const vm = this;
            axios.get('/purchase/supplier-data-migrate-pivote').then(response => {});
        },
    },
    mounted() {
        const vm = this;
        axios.get(`${window.app_url}/purchase/suppliers/vue-list`)
            .then(response => {
