    ...
    <div id="helpSupplier" class="card-body pt-1">
        ...
        <ul class="nav nav-tabs custom-tabs px-0 pt-0" role="tablist">
            ...
            <li id="helpNationalRegistry" class="nav-item">
                <a href="#rnc" class="nav-link" data-toggle="tab" title="Datos de Información del Registro Nacional de Contratistas (RNC)">
                    {{ __('Datos del RNC') }}
                </a>
            </li>
            <li id="helpRequirementDocs" class="nav-item">
                <a href="#requirement_docs" class="nav-link" data-toggle="tab" title="Consignación de requisitos en físico y digital">
                    {{ __('Documentos') }}
                </a>
            </li>
        </ul>
        <div class="tab-content">
            <div id="default_data" class="tab-pane active" role="tabpanel">
                ...
                <div class="row pb-3">
                        ...
                        <div class="form-group is-required {{ $errors->has('person_type') ? 'has-error' : '' }}">
                            ...
                            <div class="row">
                                <div class="col-12 col-sm-6 col-md-3 radio-inline text-center">
                                    <label for="personTypeN">Natural</label>
                                ...
                                <div class="col-12 col-sm-6 col-md-3 radio-inline text-center">
                                    <label for="personTypeJ">Jurídica</label>
                                    <div class="custom-control custom-switch">
                                ...
                                <div class="col-12 col-sm-6 col-md-3 radio-inline text-center">
                                    <label for="personTypeG">Gubernamental</label>
                                    <div class="custom-control custom-switch">
                                ...
                                <div class="col-12 col-sm-6 col-md-3 radio-inline text-center">
                                    <label for="personTypeE">Extranjero</label>
                                    <div class="custom-control custom-switch">
                    ...
                    <div id="helpCompanyType" class="col-12 col-lg-4">
                        <div class="form-group is-required {{ $errors->has('company_type') ? 'has-error' : '' }}">
                            ...
                            <div class="row">
                                <div class="col-12 col-sm-6 col-md-3 radio-inline text-center">
                                    <label for="companyTypePU">Pública</label>
                                    <div class="custom-control custom-switch">
                                ...
                                <div class="col-12 col-sm-6 col-md-3 radio-inline text-center">
                                    <label for="companyTypePR">Privada</label>
                                    <div class="custom-control custom-switch">
                ...
                <div class="row">
                    <div id="helpRif" class="col-12 col-md-4">
                        <div class="form-group is-required {{ $errors->has('rif') ? 'has-error' : '' }}">
                            ...
                            'class' => 'form-control input-sm', 'placeholder' => __('R.I.F.'),
                            'data-toggle' => 'tooltip', 'title' => __('R.I.F.')
                            ]) !!}
                        </div>
                    </div>
                    <div id="helpName" class="col-12 col-md-4">
                        <div class="form-group is-required {{ $errors->has('name') ? 'has-error' : '' }}">
                            ...
                            'class' => 'form-control input-sm', 'placeholder' => __('Nombre o razón'),
                            'data-toggle' => 'tooltip',
                    ...
                    <div id="helpSocialPurpose" class="col-12 col-md-4">
                        <div class="form-group {{ $errors->has('social_purpose') ? ' has-error' : '' }}">
                            {!! Form::label('social_purpose', __('Objeto Social de la organización'), ['class' => 'control-label']) !!}
                ...
                <div class="row">
                    ...
                    <div id="helpPurchaseSupplierBranch" class="col-12 col-md-4">
                        <div class="form-group is-required {{ $errors->has('purchase_supplier_branch_id') ? 'has-error' : '' }}">
                            ...
                            {!! Form::select('purchase_supplier_branch_id', $supplier_branches,
                    ...
                    <div id="helpPurchaseSupplierSpecialty" class="col-12 col-md-4">
                        <div class="form-group is-required {{ $errors->has('purchase_supplier_specialty_id') ? 'has-error' : '' }}">
                            ...
                            {!! Form::select('purchase_supplier_specialty_id',
                ...
                <div class="row">
                    <div id="helpDirection" class="col-12">
                        <div class="form-group is-required {{ $errors->has('direction') ? ' has-error' : '' }}">
                            ...
                            <ckeditor id="direction" class="form-control" data-toggle="tooltip" placeholder="{!! __('Dirección Fiscal') !!}" tag-name="textarea" rows="3" title="{!! __('Dirección Fiscal') !!}" value="{!! isset($model) ? $model->direction : old('direction') !!}" :config="ckeditor.editorConfig" name="direction" :editor="ckeditor.editor">
                            </ckeditor>
                        </div>
                    </div>
                </div>
                ...
                if($contact_names) {
                for($i = 0; $i < count($contact_names); $i++ ) { array_push($contacts, [ 'name'=> $contact_names[$i],
                    ...
                    @endphp
                    <contacts id="helpContacts" initial_data="{{ ($contacts) ? json_encode($contacts) : '' }}"></contacts>
                    <hr>
                    @php
                    $phones = [];
                    ...
                    if($phone_type) {
                    for ($i = 0; $i < count($phone_type); $i++ ) { array_push($phones, [ 'type'=> $phone_type[$i],
                        ...
                        <div class="form-group {{ $errors->has('rnc_status') ? ' has-error' : '' }}">
                            ...
                            <div id="rnc_status" class="row">
                                <div class="col-12 col-md-6 radio-inline text-center">
                                    <label for="rnc_status_inh">Inscrito y no habilitado</label>
                                    <div class="custom-control custom-switch">
                                ...
                                <div class="col-12 col-md-6 radio-inline text-center">
                                    <label for="rnc_status_ish">Inscrito y habilitado para contratar</label>
                                    <div class="custom-control custom-switch">
                ...
                <div class="row">
                    <div id="helpRncCertificateNumber" class="col-12 col-lg-6 col-xl-4">
                        <div class="form-group is-required {{ $errors->has('rnc_certificate_number') ? 'has-error' : '' }}">
                            ...
                            {!! Form::text('rnc_certificate_number', null, ['class' => 'form-control input-sm']) !!}
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="feature-list-content p-0">
                                    <div class="feature-list-content-wrapper">
                                        <div class="feature-list-content-right feature-list-content-actions">
                                            <button class="btn btn-simple btn-success btn-events" title="Presione para cargar el documento" data-toggle="tooltip" type="button" onclick="clickUploadDoc({{$reqDoc->id}})">
                                                <i class="fa fa-cloud-upload fa-2x"></i>
                                            </button>
                                            @if(isset($model)
                                            && isset($model->documents)
                                            && isset($docs_to_download['req_doc_'.$reqDoc->id]))
                                            <a class="btn btn-simple btn-primary btn-events" title="Presione para descargar el documento" data-toggle="tooltip" target="_blank" href="{{'/purchase/document/download/'.$docs_to_download['req_doc_'.$reqDoc->id]->file}}" download="{{$model->rif . ' - ' . $reqDoc->name.'.pdf'}}">
                                                <i class="fa fa-cloud-download fa-2x"></i>
                                            </a>
                                            @endif
                                            <input id="{{'doc'.$reqDoc->id}}" class="d-none" type="file" name="docs[]" onchange="uploadFile(event)" accept=".doc, .pdf, .odt, .docx" />
                                            <input id="{{'reqDoc'.$reqDoc->id}}" class="d-none" type="number" name="reqDocs[]" />
                                        </div>
                                        <div class="feature-list-content-left">
                                            @if(isset($docs_to_download['req_doc_'.$reqDoc->id]))
                                            <div class="feature-list-subheading">
                                                <span class="badge badge-success" title="El documento se ha cargado" data-toggle="tooltip">
                                                    <strong>Documento cargado</strong>
                                                </span>
                                            </div>
                                            @else
                                            <div id="{{'toload_doc'.$reqDoc->id}}" class="feature-list-heading">
                                                <div class="badge badge-danger ml-2" title="El documento aún no ha sido cargado" data-toggle="tooltip">
                                                    por cargar
                                                </div>
                                            </div>
                                            <div id="{{'loaded_doc'.$reqDoc->id}}" class="feature-list-subheading d-none">
                                                <span class="badge badge-success" title="El documento se ha cargado" data-toggle="tooltip">
                                                    <strong>Documento cargado</strong>
                                                </span>
                                            </div>
