            ...
            <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <div class="custom-control custom-switch" data-toggle="tooltip" 
                                ...
                                <input type="radio" class="custom-control-input" @click="resetInfo()" id="active_project" name="active" 
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <div class="custom-control custom-switch" data-toggle="tooltip" 
                                ...
                                <input type="radio" class="custom-control-input" @click="resetInfo()" id="active_subproject" name="active" 
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <div class="custom-control custom-switch" data-toggle="tooltip" 
                                ...
                                <input type="radio" class="custom-control-input" @click="resetInfo()" id="active_product" name="active" 
                ...
                <div class="col-md-4" id="institution_id">
                    <div class="form-group is-required">
                        <label>Institución:</label>
                            <select2 :options="institutions" data-toggle="tooltip" v-model="record.institution_id"></select2>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group is-required">
                ...
                <div class="row col-12">
                    ...
                    <div class="col-md-4" id="employers">
                        <div class="form-group is-required">
                            ...
                            <select2 :options="payroll_staffs" data-toggle="tooltip" v-model="record.employers"></select2>
                        </div>
                    </div>
                    <div class="col-md-4" id="staff_classifications">
                        <div class="form-group is-required">
                            <label>Rol:</label>
                            <select2 :options="staff_classifications_list" data-toggle="tooltip" v-model="record.staff_classifications"></select2>
                        </div>
                    </div>
                    <div style="margin-top: 0.2em">
                        <button class="btn btn-xs btn-icon btn-primary btn-custom btn-new mt-4" @click="addTeamMember()">
                ...
                <div class="row col-12">
                    <div class="col-md-2">
                        ...
                        <div class="custom-control custom-switch" data-toggle="tooltip" 
                            ...
                            <input type="checkbox" class="custom-control-input" @click="activePercentage()" id="sel_active_percentage" name="active_percentage" value="percentage" v-model="record.percentage">
                ...
                <div class="col-md-4" id="responsable_activity">
                    <div class="form-group is-required">
                        ...
                        <select2 :options="team_members" data-toggle="tooltip" v-model="record.responsable_activity"></select2>
                    </div>
                </div>
                <div class="col-md-4" id="start_date_activity">
                    <div class="form-group is-required">
                        <label for="start_date_activity">Fecha de inicio:</label>
                        <input type="date" class="form-control input-sm no-restrict" v-model="record.start_date_activity"
                               data-toggle="tooltip" title="Fecha de inicio" :min="record.start_date" :max="record.end_date">
                    </div>
                </div>
                <!--<div class="row col-12">  
                    <div class="col-md-4" id="end_date_activity">
                        <div class="form-group is-required">
                            ...
                            <input type="date" class="form-control input-sm no-restrict" v-model="record.end_date_activity"
                                   data-toggle="tooltip" title="Fecha fin" :min="record.start_date" :max="record.end_date">
                        </div>
                    </div>
                    <div style="margin-top: 0.2em">
                ...
                <div class="row col-12">  
                    ...
                    <div class="col-md-4" v-if="active_percentage == true">
                        ...
                        <input
                            ...
                            v-input-mask data-inputmask="'alias': 'numeric', 'allowMinus': 'false', 'digits': 2"
                        ...
                        <div slot="id" slot-scope="props" class="text-center">
                            <div class="d-inline-flex">
                                <project-tracking-activity-plan-activity-info :modal_id="props.row.activity_id"
                                    :url="'projecttracking/get-activity-plans-activity-info/' + props.row.activity_id" :activity_info='record.activity_plans[props.index-1]'>
    ...
    export default {
        ...
        methods: {
            ...
            editActivity(index, event) {
                ...
                //Elimimar la actividad a editar en activity_plans
                /*let num = 0;
                let actDelete = '';
                for (let act of vm.record.activity_plans) {
                    if (act.activity_id == index) {
                        actDelete = num;
                    }
                    ++num;
                }
                (vm.record.activity_plans).splice(actDelete,1);
                (vm.records2).splice(actDelete,1);
                // */
                event.preventDefault();
            },
            ...
            generateRecord() {
                ...
                if (vm.record.activity_plans.length > 0) {
                    for (let act of vm.record.activity_plans) {
                        percentage = Number(percentage) + Number(act.percentage);
                    }
                    if (percentage != 100) {
