      ...
      <div class="modal-dialog vue-crud" role="document">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h6>
              <i class="icofont icofont-copy-black inline-block ico-3x"></i>
          ...
          <div class="modal-footer">
            <div class="form-group">
              ...
              <button
                type="button"
                @click="createRecord('projecttracking/activity-status')"
            ...
            >
              ...
              <div slot="color" slot-scope="props" class="text-center">
                <input
                      ...
                      data-toggle="tooltip"
                      style="padding: 5px 12px !important; position: relative; margin:auto !important"
                      disabled
                    />
              </div>
