          ...
          <div class="modal-body">
              ...
              <div class="col-md-6">
                <div class="form-group" name="category">
                  ...
                  <select2 :options="projects_list" id="project" data-toggle="tooltip"
                    title="Seleccione el Proyecto asociado (requerido)" v-model="record.project_id">
                  </select2>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group" name="category">
                  ...
                  <select2 :options="subprojects_list" id="subproject" data-toggle="tooltip"
                    title="Seleccione el Subproyecto Asociado (requerido)" v-model="record.subproject_id">
                  </select2>
                </div>
              </div>
              <div class="col-md-6">
              ...
              <div class="col-md-6">
                <div>
                  ...
                  <input type="text" id="description" placeholder="Descripción" class="form-control input-sm"
                    data-toggle="tooltip" title="Ingrese la descripción del Producto" v-model="record.description">
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group is-required" name="category">
                  ...
                  <select2 :options="dependencies_list" id="dependencyy" data-toggle="tooltip"
                    title="Seleccione la dependencia del Producto (requerido)" v-model="record.dependency_id">
                  </select2>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group is-required" name="category">
                  ...
                  <select2 :options="payroll_staffs" id="responsablee" data-toggle="tooltip"
                    title="Seleccione la persona responsable del Producto (requerido)" v-model="record.responsable_id">
                  </select2>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group is-required" name="category">
                  ...
                  <select2 :options="type_products_list" id="product_typee" data-toggle="tooltip"
              ...
              <div class="col-md-6">
                <div class="form-group is-required">
                  ...
                  <input type="date" id="start_date" placeholder="Fecha inicial" class="form-control input-sm"
                    data-toggle="tooltip" title="Indique la fecha inicial" v-model="record.start_date">
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group is-required">
                  ...
                  <input type="date" id="end_date" placeholder="Fecha final" class="form-control input-sm no-restrict"
                    data-toggle="tooltip" title="Indique la fecha de culminación" v-model="record.end_date">
                </div>
              </div>
            </div>
            <div class="modal-footer">
              <div class="form-group">
                ...
                <button type="button" @click="createRecord('projecttracking/products-config')"
            ...
            <div class="modal-body modal-table text-center">
              <v-client-table :columns="columns" :data="records" :options="table_options">
                ...
                </div>                <div slot="id" slot-scope="props">
                  <div class="d-inline-flex">
                    <project-tracking-product-info :modal_id="props.row.id"
                      :url="'projecttracking/get-product-info/' + props.row.id">
...
export default {
  ...
  mounted() {
    const vm = this;
    $("#add_projecttracking_products-config").on('show.bs.modal', function () {
      vm.reset();
    });
    vm.getPersonal();
    vm.getProjects();
