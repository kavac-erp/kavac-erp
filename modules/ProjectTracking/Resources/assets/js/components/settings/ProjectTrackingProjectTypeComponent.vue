<template>
    ...
    >
        <a
            ...
            data-toggle="tooltip"
            @click="
                addRecord('add_project', 'projecttracking/project-type', $event)
            "
        >
            ...
            <div class="modal-dialog vue-crud" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h6>
                            <i
                                class="icofont icofont-ui-copy inline-block ico-3x"
                            ></i>
                            Tipos de Proyecto
                        </h6>
                    </div>
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group is-required">
                                    ...
                                    <input
                                        ...
                                        placeholder="Nombre"
                                        data-toggle="tooltip"
                                        title="Indique el nombre del tipo de proyecto"
                    ...
                    <div class="modal-footer">
                        <div class="form-group">
                            ...
                            <button
                                type="button"
                                @click="
                                    createRecord('projecttracking/project-type')
                                "
