      ...
      <div class="modal-dialog vue-crud" role="document">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h6>
              <i class="icofont icofont-ui-folder inline-block ico-3x"></i>
              Estatus de Entrega
            </h6>
          </div>
            ...
            <div class="row">
              <div class="col-md-3">
                <div class="form-group is-required">
                  <label>Estatus:</label>
                  <!-- <input type="" placeholder="Nombre" data-toggle="tooltip"
                    title="Indique el nombre del estatus de la entrega" class="form-control input-sm" v-model="record.name"
                    v-is-text required />
          ...
          <div class="modal-footer">
            <div class="form-group">
              ...
              <button
                type="button"
                @click="createRecord('projecttracking/delivery-status')"
          ...
          <div class="modal-body modal-table text-center">
            ...
            >
              ...
              <div slot="status" slot-scope="props" class="text-center">
                <div class="mt-3" v-html="idToStatus(props.row.status)"></div>
              </div>
...
export default {
  ...
  methods: {
    ...
    idToStatus(id) {
      if (id == 1) {
        return "Entrega antes del tiempo";
      }
      if (id == 2) {
