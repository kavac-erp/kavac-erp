...
Vue.component('project-tracking-type-products', () => import(
 ...
 */
  ...
  Vue.component('project-tracking-activity-config', () => import(
 ...
 */
Vue.component('project-tracking-project-type', () => import(
  './components/settings/ProjectTrackingProjectTypeComponent.vue'
));
 ...
 */
 Vue.component('project-tracking-projects', () => import(
  './components/settings/ProjectTrackingProjectsComponent.vue'
));
 ...
 *  @author Oscar González <xxmaestroyixx@gmail.com/ojgonzalez@cenditel.gob.ve>
 */
 Vue.component('project-tracking-project-info', () => import(
  './components/settings/ProjectTrackingProjectInfoComponent.vue'
)); 
 ...
 */
 Vue.component('project-tracking-staff-classification', () => import(
 ...
 *  @author Oscar González <xxmaestroyixx@gmail.com>
 */
Vue.component('project-tracking-personal-register', () => import(
 ...
 *  @author Oscar González <xxmaestroyixx@gmail.com/ojgonzalez@cenditel.gob.ve>
 */
 Vue.component('project-tracking-products', () => import(
  './components/settings/ProjectTrackingProductsComponent.vue'
));
 ...
 *  @author Oscar González <xxmaestroyixx@gmail.com/ojgonzalez@cenditel.gob.ve>
 */
 Vue.component('project-tracking-product-info', () => import(
  './components/settings/ProjectTrackingProductInfoComponent.vue'
)); 
 ...
 *  @author Oscar González <xxmaestroyixx@gmail.com/ojgonzalez@cenditel.gob.ve>
 */
 Vue.component('project-tracking-tasks', () => import(
 ...
 *  @author Oscar González <xxmaestroyixx@gmail.com/ojgonzalez@cenditel.gob.ve>
 */
 Vue.component('project-tracking-tasks-list', () => import(
 ...
 *  @author Oscar González <xxmaestroyixx@gmail.com/ojgonzalez@cenditel.gob.ve>
 */
 Vue.component('project-tracking-task-info', () => import(
 ...
 */
Vue.component('project-tracking-delivery-status', () => import(
 ...
 Vue.mixin({
  methods: {
    ...
    async getTypesProducts() {
      const vm = this;
      await axios.get(`${window.app_url}/projecttracking/get-type-products`).then(response => {
