...
/**
 * @class UpdateConditionToProjectTrackingProjectsTable
 ...
 */
class UpdateConditionToProjectTrackingProjectsTable extends Migration
{
    /**
    ...
    public function up()
    {
        if (Schema::hasTable('project_tracking_projects')) {
            Schema::table('project_tracking_projects', function (Blueprint $table) {
                if (Schema::hasColumn('project_tracking_projects', 'responsable_id')) {
                    $table->dropForeign('project_tracking_projects_responsable_id_foreign');
            ...
            Schema::table('project_tracking_projects', function (Blueprint $table) {
                if (!Schema::hasColumn('project_tracking_projects', 'responsable_id')) {
                    if (Module::has('Payroll')) {
                        ...
                        ->onUpdate('cascade')->comment('Responsable del proyecto');
                    } else {
