                    ...
                    <div class="row">
                        <div class="col-md-4 panel-legend" id="helpWarehouseInventoryStatusLeyendHigh">
                            <i class="ion-android-checkbox-blank text-success"
                                title="El nivel de existencia del producto es elevado"
                    ...
                    <div class="row">
                        <div class="col-md-4 panel-legend" id="helpWarehouseInventoryStatusLeyendMedium">
                            <i class="ion-android-checkbox-blank text-warning"
                                title="El nivel de existencia del producto es intermedio"
                                data-toggle="tooltip">
                            </i>
                            <span>Medio</span>
                        </div>
                    ...
                    <div class="row mg-bottom-20">
                        <div class="col-md-4 panel-legend" id="helpWarehouseInventoryStatusLeyendLow">
                            <i class="ion-android-checkbox-blank text-danger"
                                title="El nivel de existencia del producto se está agotando"
                                data-toggle="tooltip"></i>
                            <span>Bajo</span>
                        </div>
                    </div>
...
{{--
    https://gitlab.com/roldandvg/kavac_cenditel/-/issues/1178
    Se ocultó la tabla por este issue, debe resolverse en la siguiente iteración
--}}
{{-- Histórico de Operaciones --}}
{{--
    Se resolvio el envio de información a la vista ahora ya se muestra la tabla Histórico de Operaciones
--}}
<div class="row">
    <div class="col-12">
