 ...
 */
Vue.component('warehouserequest-create', () => import(
    /* webpackChunkName: "warehouserequest-create" */
 ...
 * @author Yennifer Ramirez <yramirez@cenditel.gob.ve>
 */
Vue.component('warehouserequest-list', () => import(
    /* webpackChunkName: "warehouserequest-list" */
 ...
 * @author Henry Paredes <hparedes@cenditel.gob.ve>
 */
Vue.component('warehousereception-create', () => import(
    /* webpackChunkName: "warehousereception-create" */
 ...
 * @author Henry Paredes <hparedes@cenditel.gob.ve>
 */
Vue.component('warehousereception-list', () => import(
    /* webpackChunkName: "warehousereception-list" */
 ...
 * @author Henry Paredes <hparedes@cenditel.gob.ve>
 */
Vue.component('warehouse-operations-history-information', () => import(
    ...
    methods: {
        ...
        async getBudgetSpecificActions(type) {
            ...
            if (id) {
                ...
                vm.record.budget_specific_action_id = (vm.record.budget_specific_action) ? vm.record.budget_specific_action.id : vm.record.budget_specific_action_id;
            }
        },
        /**
