 ...
 * @brief Gestiona los reportes del módulo de almacén
 *
...
class WarehouseReport implements ReportInterface
{
    ...
    /**
     * Muestra el archivo del reporte solicitado
     *
     * @param string $file Nombre del archivo
     * @param string $dest Destino del archivo (I: Impresión, D: Descarga, F: Fichero)
     *
