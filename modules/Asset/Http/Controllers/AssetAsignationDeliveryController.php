...
class AssetAsignationDeliveryController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->middleware('permission:asset.asignation.approve_reject', ['only' => 'update']);
    }
    ...
    public function managePdf($id)
    {
        ...
        $data = [];
        $data['action'] = 'Entrega';
        $data['institution'] = ($delivery['asset_asignation']['institution_id']) ? $delivery['asset_asignation']['institution']['name'] : 'N/A';
        $data['estate'] = ($delivery['asset_asignation']['institution_id']) ? $delivery['asset_asignation']['institution']['municipality']['estate']['name'] : 'N/A';
        $data['municipality'] = ($delivery['asset_asignation']['institution_id']) ? $delivery['asset_asignation']['institution']['municipality']['name'] : 'N/A';
        $data['address'] = ($delivery['asset_asignation']['institution_id']) ? strip_tags($delivery['asset_asignation']['institution']['legal_address']) : 'N/A';
        $data['fiscal_year'] = ($delivery['asset_asignation']['institution_id']) ? $delivery['asset_asignation']['institution']['fiscal_years'][0]['year'] : 'N/A';

        $date = date_create($delivery['asset_asignation']['created_at']);

        $data['created_at'] = ($date) ? date_format($date, "d/m/Y") : 'N/A';
        $data['last_name'] = ($delivery['asset_asignation']['payroll_staff']) ? $delivery['asset_asignation']['payroll_staff']['last_name'] : 'N/A';
        $data['first_name'] = ($delivery['asset_asignation']['payroll_staff']) ? $delivery['asset_asignation']['payroll_staff']['first_name'] : 'N/A';
        $data['id_number'] = ($delivery['asset_asignation']['payroll_staff_id']) ? $delivery['asset_asignation']['payroll_staff']['id_number'] : 'N/A';
        $data['department'] = ($delivery['asset_asignation']['payroll_staff_id']) ? $delivery['asset_asignation']['payroll_staff']['payroll_employment']['department']['name'] : 'N/A';
        $data['payroll_position'] = ($delivery['asset_asignation']['payroll_staff_id']) ? $delivery['asset_asignation']['payroll_staff']['payroll_employment']['payrollPosition']['name'] : 'N/A';
        $data['location_place'] = ($delivery['asset_asignation']['location_place']) ? $delivery['asset_asignation']['location_place'] : 'N/A';
        ...
        $data['approved_by'] = $approved_by['first_name'] . ' ' . $approved_by['last_name'] . ' - ' . $approved_by['payroll_employment']['payrollPosition']['name'];
        $data['received_by'] = $received_by['first_name'] . ' ' . $received_by['last_name'] . ' - ' . $received_by['payroll_employment']['payrollPosition']['name'];
