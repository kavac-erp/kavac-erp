			...
			<div slot="id" slot-scope="props" class="text-center">
				<div class="d-inline-flex">
					<asset-asignation-info
						:index="props.row.id"
						:route_list="app_url + '/asset/asignations/load-info/' + props.row.id">
					</asset-asignation-info>
					...
					<a v-if="isEditable(props.row.state)"
							@click="viewMessage()"
					...
					<button v-else @click="editForm(props.row.id)"
							class="btn btn-warning btn-xs btn-icon btn-action"
					...
					<a class="btn btn-primary btn-xs btn-icon" :href="asset_assignation_pdf + props.row.id"
