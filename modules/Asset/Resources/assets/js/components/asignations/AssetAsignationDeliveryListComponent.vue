		...
		<v-client-table :columns="columns" :data="records" :options="table_options" ref="tableMax">
			...
			<div slot="id" slot-scope="props" class="text-center">
				<div class="d-inline-flex">
					...
					<a v-if="isAcceptedRejected(props.row.state)"
							@click="viewMessage()"
							href="#"
							class="btn btn-success btn-xs btn-icon btn-action"
							title="Aceptar Entrega" data-toggle="tooltip" disabled>
					...
					<a v-if="isAcceptedRejected(props.row.state)"
							@click="viewMessage()"
							href="#"
							class="btn btn-danger btn-xs btn-icon btn-action" title="Rechazar Entrega" data-toggle="tooltip" disabled>
						<i class="fa fa-ban"></i>
					</a>
					...
					<!-- <asset-manage-record-component
							:key="props.row.id"
							:route_list="app_url + '/asset/asignations/vue-info/' + props.row.asset_asignation_id"
							:data="props.row"
							:index="props.row.id"
							:action='"Entrega"'
					...
					<button
							@click="downloadRecord(props.row.asset_asignation.code)"
					...
					<a v-if="(props.row.state == 'Aprobado' && props.row.approved_by_id && props.row.received_by_id)"
						class="btn btn-primary btn-xs btn-icon"
						:href="asset_assignation_delivery_pdf + props.row.id"
            title="Imprimir acta" data-toggle="tooltip" v-has-tooltip target="_blank">
              <i class="fa fa-print" style="text-align: center;"></i>
          </a>
						...
						<div class="row">
							<div class="col-md-6" id="approved_by_id">
								<div class="form-group is-required">
									...
									v-model="record.approved_by_id"></select2>
								</div>
							</div>
							<div class="col-md-6" id="received_by_id">
								<div class="form-group is-required">
									...
									<select2 :options="payroll_staffs" 
									v-model="record.received_by_id"></select2>
								</div>
							</div>
						</div>
					</div>
