            ...
            >
              ...
              <li class="nav-item">
                <a
                  ...
                  role="tab"
                >
                  <i class="ion-arrow-swap"></i> Bienes depreciados
                </a>
              </li>
            </ul>

            <div class="tab-content">
              <div class="tab-pane active" :id="'general' + id" role="tabpanel">
                <div class="row">
                  <div class="col-md-6">
                  ...
                  <div class="col-md-6">
                      <div class="form-group">
                          ...
                          <div class="row" style="margin: 1px 0">
                              <span class="col-md-12">
                                  {{ record.amount ? currencyFormat(record.amount, 2)  : '' }}
                              </span>
                          </div>
                      </div>
                  </div>
                  <div class="col-md-6">
                      <div class="form-group">
                          ...
                          <div class="row" style="margin: 1px 0">
                              <span class="col-md-12">
                                  {{ record.document_status ? record.document_status.name : '' }}
                              </span>
                          </div>
                      </div>
                  </div>
              ...
              <div class="tab-pane" :id="'equipment' + id" role="tabpanel">
                <div class="row">
                  <div class="col-md-12">
                    <hr />
                    <v-server-table
                    ...
                    >
                      ...
                      >
                        <span>
                          {{
                              props.row.asset.asset_specific_category_id
                      ...
                      >
                        <span>
                          {{
                            props.row.asset.acquisition_date
                          }}
                        </span>
                      </div>
                      <div
...
export default {
  ...
  mounted() {
    // Set the id attribute of the element to the value of the `value` property.
    // document.getElementById("modal-id").setAttribute("id", fields.id);
  },
