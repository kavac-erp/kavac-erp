<template>
    <section>
        <button @click="addRecord('show_asset_supplier_'+id, route_show, $event)" class="btn btn-info btn-xs btn-icon btn-action" title="Visualizar registro" data-toggle="tooltip" v-has-tooltip>
            <i class="fa fa-eye"></i>
        </button>
        <div class="modal fade text-left" tabindex="-1" role="dialog" :id="'show_asset_supplier_'+id">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body" v-if="records">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-3 ">
                                <strong>Denominación Comercial:</strong> {{ records.asset_supplier_type.name }}
                            </div>
                            <div class="col-3 ">
                                <strong>Objeto Principal:</strong>
                                <span v-for="object in records.asset_supplier_objects" :key="object.id">
                                    {{ object.name }}
                                </span>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-3 ">
                                <strong>Rama:</strong>
                                <span v-for="object in records.asset_supplier_branch" :key="object.id">
                                    {{ object.name }}
                                </span>
                                <!--{{ records.asset_supplier_branch.name }}-->
                            </div>
                            <div class="col-3 ">
                                <strong>Especialidad:</strong> <span v-for="object in records.asset_supplier_specialty" :key="object.id">
                                    {{ object.name }}
                                </span>
                                <!--{{ records.asset_supplier_specialty.name }}-->
                            </div>
                            <div class="col-3 ">
                                        ...
                                        <div class="feature-list-content p-0">
                                            <div class="feature-list-content-wrapper">
                                                <a class="btn btn-simple btn-primary btn-events"
                                                    ...
                                                    data-toggle="tooltip"
                                                    target="_blank"
                                                    :href="'/asset/document/download/'+doc.file"
                                                    :download="records.rif + ' - ' + doc.asset_document_required_document.required_document.name+'.pdf'"
                                                    >
                                                ...
                                                <div class="feature-list-content-left ml-4">
                                                    <div class="feature-list-subheading">
                                                        <i class="font-weight-bold">
                                                            {{ doc.asset_document_required_document.required_document.name }}
                                                        </i>
                                                        <p v-html="doc.asset_document_required_document.required_document.description"></p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
