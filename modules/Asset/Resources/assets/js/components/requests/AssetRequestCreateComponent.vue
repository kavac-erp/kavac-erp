      ...
      <div class="row">
        ...
        <div class="col-md-6" id="helpAssetRequestType">
          <div class="form-group is-required">
            ...
            <select2 :options="types" v-model="record.type"> </select2>
          </div>
        </div>
  ...
  methods: {
    ...
    async getEstates() {
      ...
      if (vm.record.country_id) {
        await axios
          .get(`${window.app_url}/get-estates/${vm.record.country_id}`)
          .then((response) => {
    ...
    async getMunicipalities() {
      ...
      if (vm.record.estate_id) {
        await axios
          .get(`${window.app_url}/get-municipalities/${vm.record.estate_id}`)
          .then((response) => {
    ...
    async getParishes() {
      ...
      if (vm.record.municipality_id) {
        await axios
          .get(`${window.app_url}/get-parishes/${vm.record.municipality_id}`)
          .then((response) => {
