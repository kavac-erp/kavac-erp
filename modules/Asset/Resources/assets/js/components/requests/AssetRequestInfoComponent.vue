                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="row" style="margin: 1px 0">
                        <span class="col-md-12" id="date_init"> </span>
                      </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="row" style="margin: 1px 0">
                        <span class="col-md-12" id="motive"> </span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="row" style="margin: 1px 0">
                        <span class="col-md-12" id="type"> </span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="row" style="margin: 1px 0">
                        <span class="col-md-12" id="delivery_date"> </span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="row" style="margin: 1px 0">
                        <span class="col-md-12" id="ubication"> </span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="row" style="margin: 1px 0">
                        <span class="col-md-12" id="agent_name"> </span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="row" style="margin: 1px 0">
                        <span class="col-md-12" id="agent_telf"> </span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="row" style="margin: 1px 0">
                        <span class="col-md-12" id="agent_email"> </span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    >
                      ...
                      >
                        <span>{{
                          props.row.asset.asset_details !== null
                      ...
                      >
                        <span>{{
                          props.row.asset.asset_details !== null
                            ? prepareText(props.row.asset.asset_details.model)
                            : "No definido"
                        }}</span>
                      </div>
                    </v-client-table>
      ...
      axios
        ...
        .then((response) => {
          if (typeof response.data.records !== "undefined") {
            ...
            document.getElementById("date_init").innerText = fields.created_at
              ? vm.format_date(fields.created_at)
              : "N/A";
            document.getElementById("motive").innerHTML = fields.motive
              ? fields.motive
              : "N/A";
            ...
            document.getElementById("delivery_date").innerText =
              fields.delivery_date
                ...
                : "N/A";
            document.getElementById("ubication").innerText = fields.ubication
              ? fields.ubication
              : "N/A";
            document.getElementById("agent_name").innerText = fields.agent_name
              ? fields.agent_name
              : "N/A";
            document.getElementById("agent_telf").innerText = fields.agent_telf
              ? fields.agent_telf
              : "N/A";
