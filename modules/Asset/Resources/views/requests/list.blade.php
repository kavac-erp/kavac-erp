    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <asset-request-list route_list="{{ url('asset/requests/vue-list') }}"
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <asset-request-list-pending route_list="{{ url('asset/requests/vue-pending-list') }}"
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <asset-request-list-pending route_list="{{ url('asset/requests/extensions/vue-pending-list') }}"
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <asset-request-delivery-list route_list="{{ url('asset/requests/deliveries') }}">
