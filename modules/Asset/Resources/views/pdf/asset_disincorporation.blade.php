@php
    ...
    foreach($request['assets'] as $fields) {
        if (str_contains(strtolower($fields['asset']['asset_type']['name']), 'mueble') &&
            !str_contains(strtolower($fields['asset']['asset_category']['name']), 'transporte') &&
                !str_contains(strtolower($fields['asset']['asset_category']['name']), 'semoviente') &&
                    !str_contains(strtolower($fields['asset']['asset_type']['name']), 'inmueble')
        ) {
...
@if ($furniture == true)
    ...
    <table cellspacing="0" cellpadding="4" style="font-size: 7rem;" align="center">
        <tr>
            ...
            <th style="border: solid 1px #000; font-weight: bold;" bgcolor="#D3D3D3">Valor según libros y/o contables</th>
        </tr>
        ...
        <tr align="C">
            ...
            <td style="border: solid 1px #808080;">
                {{ $fields['asset']['asset_details']['code'] ?
                    $fields['asset']['asset_details']['code'] :
                    'N/P'}}
            </td>
            <td style="border: solid 1px #808080;">
            ...
            <td style="border: solid 1px #808080;">
                {{ $fields['asset']['asset_details']['brand'] ?
                    $fields['asset']['asset_details']['brand'] :
                    'N/P' }}
            </td>
            <td style="border: solid 1px #808080;">
                {{ $fields['asset']['asset_details']['model'] ?
                    $fields['asset']['asset_details']['model'] :
                    'N/P' }}
            </td>
            <td style="border: solid 1px #808080;">
                {{ $fields['asset']['asset_details']['serial'] ?
                    $fields['asset']['asset_details']['serial'] :
                    'N/P' }}
            </td>
            <td style="border: solid 1px #808080;">
            ...
            <td style="border: solid 1px #808080;">
                {{ $fields['asset']['acquisition_date'] ?
                    $fields['asset']['acquisition_date'] :
                    'N/P' }}
            </td>
            <td style="border: solid 1px #808080;">
                {{ $fields['asset']['document_num'] ?
                    $fields['asset']['document_num'] :
                    'N/P' }}
            </td>
            <td style="border: solid 1px #808080;">
                {{ $fields['asset']['acquisition_value'] ?
                    $fields['asset']['acquisition_value'] :
                    'N/P' }}
            </td>
            <td style="border: solid 1px #808080;">
            ...
            <td style="border: solid 1px #808080;">
                {{ $fields['asset']['asset_book'] ?
                    currency_format(end($fields['asset']['asset_book'])['amount']) :
                    'N/P' }}
            </td>
        </tr>
        @php
        ...
        <tr>
            ...
            <th style="border: solid 1px #808080; {{ $styles }}"> {{ currency_format($total_depreciation_furniture) }}</th>
            <th style="border: solid 1px #808080; {{ $styles }}"> {{ currency_format($total_book_furniture) }}</th>
        </tr>
    </table>
@endif
@if ($vehicle == true)
...
<table cellspacing="0" cellpadding="4" style="font-size: 7rem;" align="center">
    ...
    <tr>
        ...
        <th style="border: solid 1px #808080; {{ $styles }}"> {{ currency_format($total_depreciation_vehicle) }}</th>
        <th style="border: solid 1px #808080; {{ $styles }}"> {{ currency_format($total_book_vehicle) }}</th>
    </tr>
</table>
@endif
@if ($lifestock == true)
...
<table cellspacing="0" cellpadding="4" style="font-size: 7rem;" align="center">
    ...
    <tr align="C">
        ...
        <td style="border: solid 1px #808080;">
            {{ $fields['asset']['asset_details']['race'] ?
                $fields['asset']['asset_details']['race'] :
                'N/P' }}
        </td>
        <td style="border: solid 1px #808080;">
        ...
        <td style="border: solid 1px #808080;">
            {{ $fields['asset']['asset_details']['weight'] ?
                $fields['asset']['asset_details']['weight'] :
                'N/P' }}
        </td>
        <td style="border: solid 1px #808080;">
            {{ $fields['asset']['asset_details']['iron_number'] ?
                $fields['asset']['asset_details']['iron_number'] :
                'N/P' }}
        </td>
        <td style="border: solid 1px #808080;">
...
<table cellspacing="0" cellpadding="4" style="font-size: 7rem;" align="center">
    ...
    <tr align="C">
        ...
        <td style="border: solid 1px #808080;">
            {{ $fields['asset']['asset_details']['land_area'] ?
                $fields['asset']['asset_details']['land_area']:
                'N/P' }}
        </td>
        <td style="border: solid 1px #808080;">
        ...
        <td style="border: solid 1px #808080;">
            {{ $fields['asset']['asset_details']['rif'] ?
                $fields['asset']['asset_details']['rif']:
                'N/P' }}
        </td>
        <td style="border: solid 1px #808080;">
