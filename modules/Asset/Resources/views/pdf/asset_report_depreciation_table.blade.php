...
<table class="table-info">
    ...
    <tr>
        <td>
            <strong>{{ $asset['asset_institutional_code']['label'] }}: </strong>{{ $asset['asset_institutional_code']['name']}} 
        </td>
        <td>
            <strong>{{ $asset['asset_subcategory']['label'] }}: </strong>{{ $asset['asset_subcategory']['name']}} 
        </td>
        <td>
            <strong>{{ $asset['asset_specific_category']['label'] }}: </strong>{{ $asset['asset_specific_category']['name']}} 
        </td>
    </tr>
</table>
