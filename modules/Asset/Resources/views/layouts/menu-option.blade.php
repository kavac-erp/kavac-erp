...
<li>
    ...
    <ul class="submenu" style="{!! display_submenu('asset') !!}">
        ...
        <li title="Gestión de ajustes de bienes institucionales" data-toggle="tooltip"
            data-placement="right"
        ...
        <li title="Gestión de Desincorporaciones de bienes institucionales" data-toggle="tooltip"
            data-placement="right"
            class="{!! set_active_menu(['asset.disincorporation.index','asset.desincorporation.create','asset.desincorporation.edit']) !!}">
        ...
        {{-- <li title="Gestión de depreciación de bienes institucionales" data-toggle="tooltip"
            data-placement="right"
            ...
            <ul class="submenu" {!! $submenuReports !!}>
                ...
                @permission('asset.depreciation.report')
                    <li class="{!! set_active_menu(['asset.report.depreciation']) !!}">
                        <a 
                            href="{{ route('asset.report.depreciation') }}" 
                            data-toggle="tooltip"
                            data-placement="right" 
