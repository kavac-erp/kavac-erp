        ...
        <div class="card-header">
            <h6 class="card-title">
                ...
                @include('buttons.help', [
                    'helpId' => 'assetSuppliers',
                    'helpSteps' => get_json_resource('ui-guides/suppliers/asset_suppliers.json', 'asset'),
                ])
            </h6>
            <div class="card-btns">
                @include('buttons.previous', ['route' => route('asset.suppliers.index')])
        ...
        <div id="helpSupplier" class="card-body pt-1">
            ...
            <div class="tab-content">
                <div id="default_data" class="tab-pane active" role="tabpanel">
                    ...
                    <div class="row">
                        <div id="helpAssetSupplierType" class="col-12 col-md-4">
                            <div
                                class="form-group is-required {{ $errors->has('asset_supplier_type_id') ? 'has-error' : '' }}">
                                {!! Form::label('asset_supplier_type_id', __('Denominación Comercial'), ['class' => 'control-label']) !!}
                                {!! Form::select('asset_supplier_type_id', $supplier_types, null, [
                                    'class' => 'form-control select2',
                                ]) !!}
                            </div>
                        </div>
                        <div id="helpAssetSupplierObject" class="col-12 col-md-4">
                            <div
                                class="form-group is-required {{ $errors->has('asset_supplier_object_id') ? 'has-error' : '' }}">
                                {!! Form::label('asset_supplier_object_id', __('Objeto Principal'), ['class' => 'control-label']) !!}
                                {!! Form::select(
                                    'asset_supplier_object_id',
                                    $supplier_objects,
                                    isset($model_supplier_objects) ? $model_supplier_objects : null,
                                    [
                                        'class' => 'form-control multiple',
                                        'multiple' => 'multiple',
                                        'name' => 'asset_supplier_object_id[]',
                                    ],
                                ) !!}
                            </div>
                        </div>
                        ...
                        @endphp
                        <div id="helpAssetSupplierBranch" class="col-12 col-md-4">
                            <div
                                class="form-group is-required {{ $errors->has('asset_supplier_branch_id') ? 'has-error' : '' }}">
                                {!! Form::label('asset_supplier_branch_id', __('Rama'), ['class' => 'control-label']) !!}
                                {!! Form::select(
                                    'asset_supplier_branch_id',
                                    $supplier_branches,
                                    isset($model_supplier_branches) ? $model_supplier_branches : null,
                                    [
                                        'class' => 'form-control multiple',
                                        'multiple' => 'multiple',
                                        'name' => 'asset_supplier_branch_id[]',
                                    ],
                                ) !!}
                            </div>
                        </div>
                        ...
                        @endphp
                        <div id="helpAssetSupplierSpecialty" class="col-12 col-md-4">
                            <div
                                class="form-group is-required {{ $errors->has('asset_supplier_specialty_id') ? 'has-error' : '' }}">
                                {!! Form::label('asset_supplier_specialty_id', __('Especialidad'), ['class' => 'control-label']) !!}
                                {!! Form::select(
                                    'asset_supplier_specialty_id',
                                    $supplier_specialties,
                                    isset($model_supplier_specialties) ? $model_supplier_specialties : null,
                                    [
                                        'class' => 'form-control multiple',
                                        'multiple' => 'multiple',
                                        'name' => 'asset_supplier_specialty_id[]',
                                    ],
                                ) !!}
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div id="helpDirection" class="col-12">
                            <div class="form-group is-required {{ $errors->has('direction') ? ' has-error' : '' }}">
                                ...
                                <ckeditor id="direction" class="form-control" data-toggle="tooltip"
                                    placeholder="{!! __('Dirección Fiscal') !!}" tag-name="textarea" rows="3"
                                    title="{!! __('Dirección Fiscal') !!}" value="{!! isset($model) ? $model->direction : old('direction') !!}"
                                    :config="ckeditor.editorConfig" name="direction" :editor="ckeditor.editor">
                                </ckeditor>
                            </div>
                        </div>
                    </div>
                                                    ...
                                                    <div class="feature-list-content-right feature-list-content-actions">
                                                        ...
                                                        @if (isset($model) && isset($model->documents) && isset($docs_to_download['req_doc_' . $reqDoc->id]))
                                                            <a class="btn btn-simple btn-primary btn-events"
                                                                ...
                                                                href="{{ '/asset/document/download/' . $docs_to_download['req_doc_' . $reqDoc->id]->file }}"
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $("#reset-select").on('click', function() {
                ...
                $('#asset_supplier_object_id').val('').change();
                $('#asset_supplier_branch_id').val('').change();
                $('#asset_supplier_specialty_id').val('').change();
