        ...
        <div class="row">
            <div class="col-md-3">
                <div class="form-group">
                    <label>Archivo:</label>
                    <!-- <label class="custom-file-label" for="consiliationFile" data-browse="Seleccionar">
                        Seleccionar Archivo
                    </label> -->
                    <div class="custom-file">
                        <input type="file" class="form-control" id="consiliationFile" lang="es" @change="fileUpload" ref="file">
                        <label class="custom-file-label" for="consiliationFile">Seleccione</label>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
