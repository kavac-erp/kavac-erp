...
<div class="row">
    <div class="col-12">
        <div class="card" id="cardFinanceMovementsForm">
            ...
            <finance-bank-movements-create :accounting="{{ $accounting ? $accounting : 0 }}" :budget="{{ $budget ? $budget : 0 }}" :entry_categories="{{ $categories }}" :accounting_list="{{ $accountingList }}" :movementid="{!! (isset($movement)) ? $movement->id : 'null' !!}">
