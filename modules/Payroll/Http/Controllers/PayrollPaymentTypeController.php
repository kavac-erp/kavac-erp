...
class PayrollPaymentTypeController extends Controller
{
     ...
     *
     * @method    getpayrollAssignedPeriods
     *
     * @author    Pedro Buitrago <pbuitrago@cenditel.gob.ve>
     *
     * @param     int    $payment_period_id    Identificador único asociado al periodo
     * @param     int    $payment_type_id    Identificador único asociado al tipo de pago
     *
     * @return    Array      result        resultado de la consulta
     *
     * @return  booleano     assigned      indica si el perido esta asociado a un registro de nómina
     */
    ...
    public function store(Request $request)
    {
        ...
        $payrollPaymentType = PayrollPaymentType::create([
            ...
            //'accounting_account_id'   => $request->finance_bank_account_id ? null : $request->accounting_account_id
    ...
    public function update(Request $request, $id)
    {
        ...
        //$payrollPaymentType->accounting_account_id   = $request->finance_bank_account_id ? null : $request->accounting_account_id;
    ...
    public function getPayrollPaymentPeriods($payment_type_id = null)
    {
        ...
        $payrollPaymentPeriodCurrent = $payrollPaymentPeriods->first(function ($period) {
            return ('pending' == $period->payment_status);
        });
