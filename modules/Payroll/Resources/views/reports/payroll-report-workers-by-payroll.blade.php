        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h6 class="card-title">Reporte de trabajadores por nómina</h6>
                    <div class="card-btns">
                ...
                @endphp
                <payroll-report-workers-by-payroll institution_id= "{{ $institution_id }}">
                </payroll-report-workers-by-payroll>
            </div>
        </div>
    </div>
@stop
