        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h6 class="card-title">Datos Contables</h6>
                    <div class="card-btns">
                ...
                <div class="card-body">
                    <payroll-staff-account-list
                        route_list="{{ url('payroll/staff-accounts/show/vue-list') }}"
                        route_delete="{{ url('payroll/staff-accounts') }}"
                        route_edit="{{ url('payroll/staff-accounts/{id}/edit') }}"
                        route_show="{{ url('payroll/staff-accounts/{id}') }}"
                    >
                    </payroll-staff-account-list>
                </div>
            </div>
