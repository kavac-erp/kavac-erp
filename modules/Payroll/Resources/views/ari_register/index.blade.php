...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <payroll-ari-register-list route_list="{{ url('payroll/get-ari-registers') }}" route_edit="{{ url('payroll/edit-ari-register') }}" route_delete="{{ url('payroll/delete-ari-register') }}">
