<template>
    <section id="PayrollEmploymentForm">
        ...
        <div class="card-body">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group is-required">
                        ...
                        <select2 :options="payroll_supervised_groups"
                                    ...
                                    @input="getSupervisedGroupData(); setTimeSheetData();">
                        </select2>
                    </div>
                    <!-- ./Código -->
                </div>
            ...
            <v-draggable-table ref="draggableTable" :custom_components="custom_components"
                               :columns="draggableColumns" :data="draggableData">
            </v-draggable-table>
            <!-- ./Tabla con los datos para la hoja de tiempo -->
            <payroll-time-sheet-pending-concepts ref="concepts"></payroll-time-sheet-pending-concepts>
            <payroll-time-sheet-pending-observations ref="observations"></payroll-time-sheet-pending-observations>
        </div>
        <!-- Final card-body -->
    ...
    export default {
        ...
        methods: {
                ...
                if (vm.record.id) {
                    ...
                    if (vm.$refs.draggableTable && typeof(vm.$refs.draggableTable) != 'undefined') {
                        ...
                        vm.$refs.draggableTable.columns.forEach((column, index) => {
                            ...
                            if (!updatedColumn.name.includes('Conceptos') && !updatedColumn.name.includes('Observación')) {
                                columns.push(
                                    {
                                        'position': index,
            ...
            async loadForm(id) {
                ...
                let recordEdit = await axios.get(`${window.app_url}/payroll/time-sheet-pending/vue-info/${id}`).then(response => {
             ...
             */
             exportTimeSheetData() {
                ...
                axios.post(`${window.app_url}/payroll/time-sheet-pending/export`, { params: data }, { responseType: 'blob' }).then(response => {
            ...
            importTimeSheetData() {
                ...
                axios.post(`${window.app_url}/payroll/time-sheet-pending/import`, formData, {
                    headers: {
                    ...
                    for (let i = 0; i < formattedColumns.length; i++) {
                        ...
                        if (valor && !col_name.includes('N°') && !col_name.includes('Nombre') && !col_name.includes('total') && !col_name.includes('Total')) {
