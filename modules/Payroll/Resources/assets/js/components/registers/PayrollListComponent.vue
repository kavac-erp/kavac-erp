            ...
            <div slot="id" slot-scope="props" class="text-center">
                <div class="d-inline-flex">
                    ...
                    <button class="btn btn-primary btn-xs btn-icon btn-action" data-toggle="tooltip"
                        @click="generatePdfReport(props.row.id)" title="Generar reporte presupuestario del registro"
                    ...
                    <button v-else :disabled="(props.row.payroll_payment_period) &&
                        (props.row.payroll_payment_period.payment_status != 'pending'
                            || props.row.payroll_payment_period.availability_status === 'available')"
                    ...
                    <button
                        :disabled="(props.row.payroll_payment_period) && (props.row.payroll_payment_period.payment_status != 'pending'
                            || props.row.payroll_payment_period.availability_status != 'available' && moment_close_permission != true)"
                        @click="closeRecord(props.row.id)" class="btn btn-default btn-xs btn-icon btn-action"
                        data-toggle="tooltip" title="Cerrar registro" data-placement="bottom" type="button">
...
export default {
    ...
    async created() {
        ...
        vm.table_options.headings = {
            ...
            'payroll_payment_period.payroll_payment_type.name': 'Tipo de pago',
            'id': 'Acción'
        };
