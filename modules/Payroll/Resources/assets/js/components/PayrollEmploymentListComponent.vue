    ...
    <div>
        ...
        >
            ...
            <div slot="id" slot-scope="props" class="text-center">
                ...
                <button
                    @click="deleteRecord(props.row.id, route_delete)"
...
<script>
    export default {
        ...
        methods: {
            ...
            time_apn(record) {
                const vm = this;
                let diff = vm.diff_datetimes(record.startDateApn)
                record.service_years = diff.years < 0 ? diff.years * -1 : diff.years;
            },
        ...
        async mounted() {
            ...
            await axios.get('/payroll/employments/show/vue-list')
            .then(response => {
