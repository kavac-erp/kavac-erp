<template>
    <div
        id="PayrollTimeSheetInfo"
        class="modal fade"
        tabindex="-1"
        role="dialog"
        aria-labelledby="PayrollTimeSheetInfoModalLabel"
        aria-hidden="true"
    >
        <div
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h6>
                        ...
                        Información Detallada de la Hoja de Tiempo
                    </h6>
                </div>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="general" role="tabpanel">
                            ...
                            <div style="border-top: 1px solid #eeeeee !important;">
                                ...
                                <div>
                                    <div class="col-md-12">
                                        <v-client-table ref="tableResults" :columns="draggableColumns" :data="draggableData" :options="table_options"></v-client-table>
                                    </div>
                                </div>
                            </div>
                        </div>
             ...
             */
             setTimeSheetColumns() {
                ...
                if (vm.record.payroll_time_sheet_parameter_id) {
                    ...
                    let draggableColumnNames = draggableColumns.map(column => column.name);

                    vm.draggableColumns = draggableColumnNames;
                } else {
                    vm.draggableColumns = [];
                }
            },
