<template>
    <div id="PayrollRescheduleVacation" class="modal fade" tabindex="-1" role="dialog"
        aria-labelledby="PayrollRescheduleVacationModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-md-4 with-border with-radius"
                                    :key="vacation_request_for_period['period']"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row" style="margin: 1px 0">
                                            <span class="col-md-12"> {{ vacation_request_for_period['days_requested'] }}
                                            </span>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4" id="helpPayrollVacationRequestDate">
                            <div class="form-group is-required">
                                ...
                                <input type="date" readonly data-toggle="tooltip"
                                    title="Fecha de generación de la solicitud" class="form-control input-sm"
                        ...
                        <div class="col-md-4" id="helpPayrollVacationRequestInstitution" v-if="is_admin">
                            <div class="form-group is-required">
                                ...
                                <select2 :options="institutions" v-model="record.institution_id" disabled>
                                </select2>
                            </div>
                        </div>
                        <!-- ./institution -->
                        ...
                        <div class="col-md-4" id="helpPayrollVacationRequestStaff">
                            <div class="form-group is-required">
                                ...
                                <select2
                                    ...
                                    v-model="record.payroll_staff_id" disabled
                                ></select2>
                            </div>
                        </div>
                        <!-- ./trabajador -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4" id="helpPayrollVacationStartDate">
                            <div class="form-group is-required" style="z-index: unset;">
                                ...
                                <input type="date" id="start_date" data-toggle="tooltip"
                                title="Fecha de inicio de vacaciones" @input="getcalculate()" :min="getMinDate()"
                        ...
                        <div class="col-md-4" id="helpPayrollVacationEndDate">
                            <div class="form-group is-required">
                                ...
                                v-model="record.end_date" :min="getMinDate()" :max="getMaxDate()"
                                @input="getcalculate()">
                            </div>
                        </div>
                        <!-- ./fecha de culminación de vacaciones -->
                ...
                <div class="card-footer text-right" id="helpParamButtons">
                    ...
                    <button type="button" @click="createRecord('payroll/vacation-requests')"
                        class="btn btn-primary btn-sm btn-round btn-modal-save" data-toggle="tooltip"
                        title="Guardar replanificación" v-has-tooltip aria-label="Guardar replanificación">
                        Guardar
                    </button>
                </div>
            </div>
            ...
            if (vm.record.id) {
                ...
                if (vm.record.vacation_period_year.length > 1) {
                    ...
                    if (vm.pending_days >= 0) {
                        vm.record.vacation_period_year[0].vacation_days = parseInt(document.getElementById('vacation_days_to_antiquity').innerText);
                    }
                }
