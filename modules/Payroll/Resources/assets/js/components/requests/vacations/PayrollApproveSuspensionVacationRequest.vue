<template>
    <div class="modal fade text-left" tabindex="-1" role="dialog" id="PayrollApproveSuspensionVacationRequest">
        <div class="modal-dialog modal-xs" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button @click="updateRecord('/payroll/suspension-vacation-requests/approved')" type="button"
