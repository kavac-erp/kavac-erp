<template>
    <section id="payrollVacationRequestShow">
        <a class="btn btn-info btn-xs btn-icon btn-action" href="#" title="Ver información del registro"
            data-toggle="tooltip" v-has-tooltip @click="addRecord('view_vacation_request' + id, route_show, $event)">
            <i class="fa fa-eye"></i>
        </a>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row" style="margin: 1px 0">
                                        <span class="col-md-12" id="days_requested">
                                            {{ format_date(record.start_date, 'DD-MM-YYYY') + ' - ' +
                                                format_date(record.end_date, 'DD-MM-YYYY') }}
                                        </span>
                                    </div>
                                </div>
                            </div>
