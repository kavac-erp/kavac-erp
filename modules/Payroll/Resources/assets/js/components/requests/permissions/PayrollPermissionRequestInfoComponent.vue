            ...
            initRecords(url,modal_id){
            	...
            	axios.get(`${window.app_url}/${url}`).then(response => {
					if (typeof(response.data.record) !== "undefined") {
		            	...
		            	document.getElementById('date').innerText = (fields.date)? vm.format_date(fields.date) :'N/A';
		            	...
		            	document.getElementById('start_date').innerText = (fields.start_date)? vm.format_date(fields.start_date)  :'N/A';
		            	document.getElementById('end_date').innerText = (fields.end_date)? vm.format_date(fields.end_date)  :'N/A';
