                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            >
                                                <span
                                                    class="col-md-12"
                                                    id="payroll_permission_policy_id"
                                                >
                                                </span>
                                            </div>
                                        </div>
                ...
                .then((response) => {
                    if (typeof response.data.record !== "undefined") {
                        ...
                        document.getElementById("date").innerText = fields.date
                            ? vm.format_date(fields.date)
                            : "N/A";
                        document.getElementById("payroll_staff_id").innerText =
                            fields.payroll_staff_id
                                ? fields.payroll_staff.id
                                    ? fields.payroll_staff.first_name +
                                      " " +
                                      fields.payroll_staff.last_name
                                    : "No definido"
                                : "No definido";
                        document.getElementById(
                            "payroll_permission_policy_id"
                        ).innerText = fields.payroll_permission_policy_id
                            ? fields.payroll_permission_policy.name
                            : "N/A";
                        document.getElementById("start_date").innerText =
                            fields.start_date
                                ? vm.format_date(fields.start_date)
                                : "N/A";
                        document.getElementById("end_date").innerText =
                            fields.end_date
                                ? vm.format_date(fields.end_date)
                                : "N/A";
                        document.getElementById("time_permission").innerText =
                            fields.time_permission
                                ? fields.time_permission
                                : "N/A";
                        document.getElementById("motive_permission").innerText =
                            fields.motive_permission
                                ? fields.motive_permission
                                : "N/A";
                    }
