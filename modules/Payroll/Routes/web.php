...
use Modules\Payroll\Http\Controllers\SendPayrollPaymentTypeReceiptsController;
use Modules\Payroll\Http\Controllers\PayrollCoordinationController;
use Modules\Payroll\Http\Controllers\PayrollResponsibilityController;
...
Route::group([
    ...
    /** Ruta que obtiene un arreglo con los datos registrados de la tabla
    ...
    */
    ...
    /** Ruta que permite obtener de manera agrupada el conteo de empleados
    ...
    */
    ...
    Route::group([
        ...
        Route::post('staffs/create', 'PayrollReportController@create')
