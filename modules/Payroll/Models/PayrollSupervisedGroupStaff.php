...
/**
 * @class PayrollSupervisedGroupStaff
 ...
 */
class PayrollSupervisedGroupStaff extends Model implements Auditable
{
    use SoftDeletes;
    use AuditableTrait;
    use ModelsTrait;
     ...
     * @var array $fillable
     */
    protected $fillable = ['payroll_supervised_group_id', 'payroll_staff_id'];
