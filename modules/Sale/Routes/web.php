...
|--------------------------------------------------------------------------
|
| Acá se registran las rutas para el módulo de Comercialización
|
*/
...
Route::group(
    ...
    function () {
        ...
        Route::get('order/vue-list', 'SaleOrderSettingController@getListOrder');
        Route::get('order/list-pending', 'SaleOrderSettingController@getListPending');
        ...
        Route::get('get-order-status', 'SaleOrderSettingController@getSaleOrderStatus');
        Route::get('get-order-with-clients', 'SaleOrderSettingController@getSaleOrderClients');
        Route::get('get-order-years', 'SaleOrderSettingController@getSaleOrdersYear');
        Route::get('get-order-range-dates', 'SaleOrderSettingController@getSaleOrderRangeDates');
        Route::get('reports/orders', 'Reports\SaleOrderReportController@index')
            ->name('sale.report.orders');
        Route::post('reports/orders/data', 'Reports\SaleOrderReportController@orderSearch');
        Route::get('reports/orders/pdf/{ListIds}', 'Reports\SaleOrderReportController@pdf');
        ...
        */
        ...
        Route::get('get-quote-payment', 'SaleQuoteController@getSaleChargeMonies');
        ...
        Route::get('payment/payment_approve', 'SalePaymentController@paymentApprove');
        Route::get('payment/payment_rejected', 'SalePaymentController@paymentRejected');
        Route::get('payment/advance_define_attributes_approve', 'SalePaymentController@advanceDefineAttributesApprove');
