...
class SaleWarehouseReceptionController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('sale::receptions.list', compact('hasRole'));
    }
    ...
    public function store(Request $request)
    {
        $this->validate(
            ...
            [
                'institution_id.required' => 'El campo Nombre de la institución es obligatorio.',
                'sale_warehouse_id.required' => 'El campo Nombre del almacén es obligatorio.',
                'sale_warehouse_inventory_products.required' => 'Ingrese al menos un insumo a la solicitud.',
            ]
        );
