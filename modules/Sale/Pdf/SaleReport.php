...
/**
 * @class SaleReport
 * @brief Gestiona los reportes del módulo de comercialización
 *
 * @license
...
class SaleReport implements ReportInterface
{
     ...
     *
     * @var integer|object $institution
     */
    private $institution;
     ...
     * @param string $dest Tipo de descarga
     *
    ...
    public function show($file, $dest = 'I')
    {
        ...
        if ($dest == 'F') {
            return \Illuminate\Support\Facades\Response::download($filename);
        };
    }
