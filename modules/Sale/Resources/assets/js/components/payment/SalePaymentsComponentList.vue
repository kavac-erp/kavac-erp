...
<script>
    export default{
        data(){
            return{
                records:[],
                columns: ['payment_date', 'name','sale_goods_name', 'total_amount','reference_number', 'tstatus','id'],
            }
        },
        created(){
            ...
            this.table_options.sortable = ['payment_date', 'name', 'sale_goods_name', 'total_amount', 'reference_number', 'tstatus'];
            this.table_options.filterable = ['payment_date', 'name', 'sale_goods_name', 'total_amount', 'reference_number', 'tstatus'];
            this.table_options.columnsClasses = {
                'payment_date': 'col-xs-1',
                'name': 'col-xs-2',
