<template>
  <section id="SaleQuoteViewClients">
    <div class="card-body">
      ...
      <h6 class="card-title">II Descripción de productos/servicios:</h6>
      <div class="row">
        ...
        <div v-show="record.product_type == 'Producto'" class="col-md-3">
          <div class="form-group is-required">
            <label for="sale_warehouse_method_id">Almacén:</label>
            <select2 :options="sale_warehouse_method_list" id="sale_warehouse_method_id" v-model="record.sale_warehouse_method_id"></select2>
          </div>
        </div>
        <div v-show="record.product_type == 'Producto'" class="col-md-3">
          <div class="form-group is-required">
        ...
        <div class="col-md-3" id="HelpUnitPrice">
          <div class="form-group is-required">
            <label>Costo:</label>
            <input type="text" placeholder="Costo" id="value" title="Costo" v-model="record.value" class="form-control input-sm" required @change="updateTotalProduct()">
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-md-3" id="HelpPaymentForm">
          <div class="form-group is-required">
            ...
            <select2 :options="quote_payments" v-model="record.sale_charge_money_id" id="sale_charge_money_id"></select2>
          </div>
        </div>
    ...
    data() {
      return {
        record: {
          ...
          sale_quote_products: [],
          //Complementarios
          sale_charge_money_id: '',
          deadline_date: this.dateNow(),
          sale_warehouse_method_id: ''
        },
        sale_quote_products: [],
        product_position_value: 0,
        quote_clients: [],
    ...
    methods: {
      ...
      getSaleWarehouseMethod() {
        ...
        axios.get('/sale/get-salewarehousemethod').then(response => {
          vm.sale_warehouse_method_list = response.data;
        });
      },
      /**
      ...
      */
      addClient(index, client) {
        ...
        this.record.phone = client.sale_clients_email && client.sale_clients_email.length? client.sale_clients_phone[0].phone : '';
      ...
      */
      extractQuote() {
        ...
        if (vm.quote) {
          ...
          vm.record.sale_charge_money_id = vm.quote.sale_charge_money_id;
      ...
      */
      record: {
        ...
        handler: function() {
          ...
          if (vm.quote_edit && $('#sale_charge_money_id option').length > 1) {
            if (vm.record.sale_charge_money_id != vm.quote.sale_charge_money_id) {
              $("#sale_charge_money_id").val(vm.quote.sale_charge_money_id).select2();
              vm.record.sale_charge_money_id = vm.quote.sale_charge_money_id;
            }
            else {
              vm.quote_edit = false;
          ...
          if (vm.quote_edit && vm.record.sale_charge_money_id != vm.quote.sale_charge_money_id) {
            vm.record.sale_charge_money_id = vm.quote.sale_charge_money_id;
          }
        }
      }
