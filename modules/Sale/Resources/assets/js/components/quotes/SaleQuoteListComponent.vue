      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="col-md-6" id="SaleHelpPaymentMethod">
              <label>Almacén:</label>
              <div class="data-value"><span>{{ quote_load.sale_warehouse_method.name }}</span></div>
            </div>
          ...
          <div class="row">
            <div class="col-md-6" id="SaleHelpPaymentMethod">
              ...
              <div class="data-value"><span>{{ quote_load.sale_charge_money.name_charge_money }}</span></div>
            </div>
            <div class="col-md-6">
    ...
    data() {
      return {
        ...
        quote_load: {
          ...
          sale_warehouse_method: {},
          sale_payment_method_list: {},
          deadline_date: '',
        },
        columns_products: [
          'product_type',
