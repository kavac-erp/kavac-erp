@foreach ($quotes as $quote)
    ...
    @if (isset($quote->SaleQuoteProduct) && count($quote->SaleQuoteProduct) > 0)
        <table cellspacing="0" cellpadding="1" border="0">
            <tr>
                <th width="10%" style="font-size:9rem; background-color: #BDBDBD;" align="center">Tipo de Producto
                </th>
                ...
                <th width="10%" style="font-size:9rem; background-color: #BDBDBD;" align="center">Unidad de medida
                </th>
    ...
    <table cellspacing="1" cellpadding="0" border="0">
        <tbody>
            <tr>
                ...
                <td style="font-size:9rem;" width="50%">
                    <strong>Fecha límite de
                        respuesta:</strong><br>{{ date('d / m / Y', strtotime($quote->deadline_date)) }}
                </td>
            </tr>
        </tbody>
    </table>
