			...
			{!! Form::open(['id' => 'form-codes', 'route' => 'sale.settings.store', 'method' => 'post']) !!}
				...
				<div class="card-body">
					...
					<div class="row">
						...
						<div class="col-md-3" id="helpCodeSaleOrder">
							<div class="form-group">
								{!! Form::label('sale_order_code', 'Código para los Pedidos', []) !!}
								{!! Form::text('orders_code', ($saleOrderCode) ? $saleOrderCode->format_code : old('orders_code'), [
									'class' => 'form-control input-sm', 'data-toggle' => 'tooltip',
									'title' => 'Formato para el código de los reportes de inventario de productos',
									'placeholder' => 'Ej. XXX-00000000-YYYY',
									'readonly' => ($saleOrderCode) ? true : false
								]) !!}
							</div>
						</div>
						<div class="col-md-3" id="helpCodeSaleQuote">
							<div class="form-group">
								{!! Form::label('sale_quote_code', 'Código para las Cotizaciones', []) !!}
								{!! Form::text('quotes_code', ($saleQuoteCode) ? $saleQuoteCode->format_code : old('quotes_code'), [
									'class' => 'form-control input-sm', 'data-toggle' => 'tooltip',
									'title' => 'Formato para el código de los reportes de inventario de productos',
									'placeholder' => 'Ej. XXX-00000000-YYYY',
									'readonly' => ($saleQuoteCode) ? true : false
								]) !!}
							</div>
						</div>
				...
				@if (!$pdCode || !$mvCode || !$billCode || !$serviceCode || !$saleWarehouseReportCode || !$saleOrderCode|| !$saleQuoteCode)
