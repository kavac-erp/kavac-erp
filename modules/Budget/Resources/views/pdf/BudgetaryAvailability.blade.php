        ...
        <thead>
            <tr>
                <th width="35%" style="font-size:9rem;">
                    ...
                    <br>
                    {{ isset($record['purchaseRequirement']) ? $record['purchaseRequirement']['code'] : '' }}
                </th>
                <th width="40%" style="font-size:9rem;">
                    <strong>Descripción:</strong>
                    <br>
                    {{ isset($record['purchaseRequirement']) ? $record['purchaseRequirement']['description'] : '' }}
                </th>
                <th width="25%" style="font-size:9rem;">
                    <strong>Año fiscal:</strong>
                    <br>
                    {{ isset($record['purchaseRequirement']) ? $record['purchaseRequirement']['fiscalYear']['year'] : '' }}
                </th>
            </tr>
            <tr>
                <th width="100%"></th>
            ...
            <tr>
                <th width="35%" style="font-size:9rem;">
                    ...
                    <br>
                    {{ isset($record['purchaseRequirement']) ? $record['purchaseRequirement']['contratingDepartment']['name'] : '' }}
                </th>
                <th width="40%" style="font-size:9rem;">
                    <strong>Departamento Usuario:</strong>
                    <br>
                    {{ isset($record['purchaseRequirement']) ? $record['purchaseRequirement']['userDepartment']['name'] : '' }}
                </th>
                <th width="25%" style="font-size:9rem;">
                    <strong>Tipo:</strong>
                    <br>
                    {{ isset($record['purchaseRequirement'])
                        ? $record['purchaseRequirement']['purchaseSupplierObject']['name']
                        : '' }}
                </th>
            </tr>
            <tr>
            ...
            <tr>
                <th width="35%" style="font-size:9rem;">
                    ...
                    <br>
                    {{ isset($record['purchaseRequirement'])
                        ? date('d/m/Y', strtotime($record['purchaseRequirement']['date']))
                        : '' }}
                </th>
                <th width="25%" style="font-size:9rem;">
        ...
        <tbody>
                ...
                <tr>
                    <td width="15%" align="center">
                        {{ $recordRelatable['purchaseRequirementItem']
                            ? ($recordRelatable['purchaseRequirementItem']['purchaseRequirement']
                                ? $recordRelatable['purchaseRequirementItem']['purchaseRequirement']['code']
                                : '')
                            : '' }}
                    </td>
                    <td width="15%">
                        {{ $recordRelatable['purchaseRequirementItem'] ? $recordRelatable['purchaseRequirementItem']['name'] : '' }}
                    </td>
                    <td width="15%">
                        {{ $recordRelatable['purchaseRequirementItem']
                            ? $recordRelatable['purchaseRequirementItem']['technical_specifications']
                            : '' }}
                    </td>
                    <td width="10%" align="center">
                        {{ $recordRelatable['purchaseRequirementItem'] ? $recordRelatable['purchaseRequirementItem']['quantity'] : '' }}
                        {{ $recordRelatable['purchaseRequirementItem']
                            ? ($recordRelatable['purchaseRequirementItem']
                                ? ($recordRelatable['purchaseRequirementItem']['measurementUnit']
                                    ? $recordRelatable['purchaseRequirementItem']['measurementUnit']['name']
                                    : '')
                                : '')
                            : '' }}
                    </td>
                    <td width="15%" align="right">
                        {{ $recordRelatable['purchaseRequirementItem'] ? $recordRelatable['purchaseRequirementItem']['unit_price'] : '' }}
                    </td>
                    <td width="15%" align="right">
                        {{ $recordRelatable['purchaseRequirementItem']
                            ? ($record['currency']
                    ...
                    <td width="15%" align="center">
                        {{ $recordRelatable['purchaseRequirementItem']
                            ? ($recordRelatable['purchaseRequirementItem']['historyTax']
                                ? ($recordRelatable['purchaseRequirementItem']['historyTax']['percentage'] / 100) * 100
                                : '0')
                            : '' }}%
                    </td>
                    @php
                        $quantityPrice = $recordRelatable['purchaseRequirementItem']
                            ? ($recordRelatable['purchaseRequirementItem']['unit_price']
                                ? $recordRelatable['purchaseRequirementItem']['unit_price'] *
                                    $recordRelatable['purchaseRequirementItem']['quantity']
                                : 0)
                        ...
                        $ivaSumatoria += $recordRelatable['purchaseRequirementItem']
                            ? ($recordRelatable['purchaseRequirementItem']
            ...
            @foreach ($bases_imponibles as $percentage => $base)
                ...
                <tr>
                    ...
                    <td width="30%" align="right">
                        {{ round(($base * $percentage) / 100, $record['currency'] ? $record['currency']['decimal_places'] : 2) }}
                    </td>
                </tr>
            @endforeach
        </tbody>
        ...
        <tfoot>
            <tr style="background-color: #BDBDBD;">
                ...
                <td width="30%" align="center" style="font-size:8rem;">
                    <strong>
                        {{ $record['currency'] ? round($total, $record['currency']['decimal_places']) : 0 }}
                    </strong>
                </td>
            </tr>
        </tfoot>
...
@else
        ...
        <thead>
            <tr>
                ...
                <th width="25%" style="font-size:9rem;">
                    ...
                    <br>
                    {{ date('d/m/Y', strtotime($record['payrollPaymentPeriod']['start_date'])) .
                        ' - ' .
                        date('d/m/Y', strtotime($record['payrollPaymentPeriod']['end_date'])) }}
                </th>
            </tr>
            <tr>
                <th width="100%"></th>
            ...
            <tr>
                <th width="35%" style="font-size:9rem;">
                    ...
                    <br>
                    {{ $record['payrollPaymentPeriod']['payrollPaymentType']['name'] }}
                </th>
                <th width="40%" style="font-size:9rem;">
                    <strong>TOTAL
                        {{ $record['payrollPaymentPeriod']['payrollPaymentType']['payrollConcepts'][0]['currency']['symbol'] }}:</strong>
                    <br>
                    {{ $totalAmount }}
                </th>
            </tr>
    ...
    <table cellspacing="0" cellpadding="2" border="0.1" style="font-size: 7rem;">
        <thead>
            <tr style="background-color: #BDBDBD;">
                <th width="25%" align="center"><b>Acción específica</b></th>
                <th width="25%" align="center"><b>Cuenta</b></th>
                <th width="25%" align="center"><b>Monto Concepto</b></th>
                <th width="25%" align="center"><b>Monto Cuenta</b></th>
            </tr>
        </thead>
        <tbody>
            @foreach ($accounts as $account)
                <tr>
                    <td width="25%" align="center">
                        {{ strip_tags($account['budget_specific_action_desc']) }}
                    </td>
                    <td width="25%" align="center">
