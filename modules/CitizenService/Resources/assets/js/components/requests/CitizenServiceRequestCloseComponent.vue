                ...
                <div class="modal-content">
                            ...
                            <div class="col-md-6">
                                <div class="form-group is-required">
                                    ...
                                    <input
                                        ...
                                        v-model="record.date_verification"
                                    />
                            ...
                            <div class="col-6">
                                <div class="input-group">
                                    <input
                                        ...
                                        class="d-none"
                                        type="file"
                                        accept=".doc, .pdf, .odt, .docx, .jpg, .png, .jpeg, .mp4, .avi"
                                        @change.prevent="processFiles()"
                                    />
                                    <label for="file">
                                        <a
                                            class="btn btn-sm btn-primary btn-info text-light"
                                        >
                                            Subir archivo
                                        </a>
                                    </label>
                    ...
                    <div class="modal-footer">
                        ...
                        <button
                            type="button"
                            @click="
                                createRecord('/citizenservice/request-close')
                            "
