<template>
	<div class="col-xs-2 text-center">
		<a class="btn-simplex btn-simplex-md btn-simplex-primary" href="#"
		   title="Registros de tipos de impactos" data-toggle="tooltip"
		   @click="addRecord('add_citizenservice-effect-type', 'citizenservice/effect-types', $event)">
	                ...
	                <div class="modal-body modal-table">
	                	<v-client-table :columns="columns" :data="records" :options="table_options">
	                		<div slot="id" slot-scope="props" class="text-center">
		                		...
		                		<button @click="deleteRecord(props.row.id, 'citizenservice/effect-types')"
