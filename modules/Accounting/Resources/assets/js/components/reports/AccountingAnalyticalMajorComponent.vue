<template>
    <div class="form-horizontal">
        ...
        <div class="card-footer text-right">
            <button class="btn btn-primary btn-sm" title="Generar Reporte" data-toggle="tooltip" v-has-tooltip v-on:click="OpenPdf(getUrlReport(), '_blank')" id="helpAnaliticalMajorGenerateReport">
