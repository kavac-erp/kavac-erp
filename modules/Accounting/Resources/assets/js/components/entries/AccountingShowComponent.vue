                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-4"><strong>Institución:</strong> {{ institution }}</div>
                                ...
                                <table class="table table-striped table-hover">
                                    <thead>
                                        <tr class="row">
                                            ...
                                            <th tabindex="0" class="col-6" style="border: 1px solid #dee2e6; position: relative;">
                                                Denominación
                                            </th>
                                            <th tabindex="0" class="col-2" style="border: 1px solid #dee2e6; position: relative;">
                                                Debe
                                    ...
                                    <tbody>
                                        <tr v-for="(row, index) in accounting_accounts" :key="index" class="row">
                                            <td style="border: 1px solid #dee2e6;" tabindex="0" class="col-2 text-left">
                                                {{   row.account.group + "." + row.account.subgroup + "." + row.account.item + "." + row.account.generic + "." + row.account.specific + "." + row.account.subspecific + "." + row.account.institutional }}
                                            </td>
                                            <td style="border: 1px solid #dee2e6;" tabindex="0" class="col-6 text-left">
