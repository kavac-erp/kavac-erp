      ...
      <form @submit.prevent="" class="form-horizontal">
          <div class='row' style='margin:10px 0'>
              <div class='col-12 form-group'>
                  ...
                  Es necesario cambiar al menos un parámetro de búsqueda para realizar una nueva búsqueda.
                  </span>
              ...
              <div class="row" style='margin:10px 0'>
                  <div class="col-xs-6 col-sm-6 col-md-2" id="helpSearchEntriesReference">
                      <div class="form-group">
                          ...
                          <div class="custom-control custom-switch">
                            <input type="radio" name="sel_Search" 
                            class="custom-control-input sel_search" id="sel_ref"
                            @click="resetByOrigin()">
                  ...
                  <div class="col-xs-6 col-sm-6 col-md-2" id="helpSearchEntriesCategory">
                      <div class="form-group">
                          ...
                          <div class="custom-control custom-switch">
                            <input type="radio" name="sel_Search" class="custom-control-input sel_search"
                            id="sel_origin" checked
...
export default {
    ...
    methods: {
        ...
        ErrorsInForm: function() {
            ...
            let validFilterDate = this.filterDate == "specific" ?
