            ...
            <accounting-show-errors ref="accountingConverterForm" />
             <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-6 is-required" id="helpSelectBudget">
                    ...
                    <select2 
                        :options="budgetOptions" v-model="budgetSelect" data-toggle="tooltip" 
                ...
                <div class="col-xs-12 col-sm-12 col-md-6 is-required" id="helpSelectAccounting">
                    ...
                    <select2 
                        :options="accountingOptions" v-model="accountingSelect" data-toggle="tooltip" title="Seleccione una cuenta patrimonial"
                    ></select2>
                </div>
            </div>
        </div>
