<template>
    <div class="col-xs-2 text-center">
        <a class="btn-simplex btn-simplex-md btn-simplex-primary" href="" title="Catálogo de Cuentas patrimoniales" data-toggle="tooltip" v-has-tooltip @click="addRecord('crud_accounts', 'accounting/accounts', $event)">
