...
@if(isset($initDate) || isset($endDate))
	<h2 align="center" style="font-size: 9rem;">LIBRO DIARIO DESDE {{$initDate}} HASTA {{$endDate}} </h2>
@else
	<h2 align="center" style="font-size: 9rem;">ASIENTO CONTABLE </h2>
@endif
...
@if($Entry)
	...
	<table cellspacing="0" cellpadding="1" border="0">
		...
		<tr>
			<th style="font-size:9rem;" width="50%"> Concepto: {{ $concept }}</th>
			<th style="font-size:9rem;" width="50%"> Observaciones: {{ $observations }}</th>
		</tr>
...
@else
	...
	<table cellspacing="0" cellpadding="1" border="1">
		<tr>
			...
			<th width="14%" style="font-size:9rem; " align="center">Concepto</th>
			<th style="font-size:9rem;" width="15%" align="center">Código</th>
			<th style="font-size:9rem;" width="35%" align="center">Cuentas</th>
			<th style="font-size:9rem;" width="13%" align="center">Debe</th>
			<th style="font-size:9rem;" width="13%" align="center">Haber</th>
		</tr>
	</table>
	@foreach($entries as $entry)
		<table cellspacing="0" cellpadding="1" border="0">
			<tr >
				...
				<td width="14%" style="font-size:9rem; background-color: #BDBDBD;"></td>
				<td width="15%" style="font-size:9rem; background-color: #BDBDBD;"></td>
		        <td width="35%" style="font-size:9rem; background-color: #BDBDBD;" align="center">
		        	{{ $cont }}
		        	@php
		        		$cont++;
		        	@endphp
		        </td>
		        <td width="13%" style="font-size:9rem; background-color: #BDBDBD;"></td>
		        <td width="13%" style="font-size:9rem; background-color: #BDBDBD;"></td>
			</tr>
			@foreach($entry['accountingAccounts'] as $entryAccount)
				<tr>
