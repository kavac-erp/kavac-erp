 ...
 * @brief Gestiona la exportación de datos del reporte del libro diario
 *
 * Realiza el proceso de exportación de datos del reporte del libro diario
 *
...
class AccountingDailyBookSheetExport implements WithDrawings, FromView, WithStyles
{
    ...
    {
        return view('accounting::xlsx.entry_and_daily_book', [
            'pdf' => $this->data['pdf'],
            'entries' => $this->data['entries'],
            'convertions' => $this->data['convertions'],
