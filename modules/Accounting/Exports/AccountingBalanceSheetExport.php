 ...
 * @brief Gestiona la exportación de datos del reporte de balance general
 *
 * Realiza el proceso de exportación de datos del reporte de balance general
 *
...
class AccountingBalanceSheetExport implements WithDrawings, FromView, WithStyles
{
    ...
    {
        return view('accounting::xlsx.balance_sheet', [
            'pdf' => $this->data['pdf'],
