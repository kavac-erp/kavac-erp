...
Route::group(['middleware' => ['auth', 'verified', 'role:admin']], function () {
    ...
    Route::group(['namespace' => 'Auth', 'prefix' => 'auth'], function () {
        ...
        Route::post(
            'settings/users/send-credentials',
            [UserController::class, 'sendCredentials']
        )->name('access.settings.users.send-credentials');
        ...
        Route::get('restore/user/{user}', 'UserController@restore')->name('restore.user');
    });
});
