...
Route::get('test-reports', function () {
    /* Familia de fuente a utilizar en el reporte */
    $fontFamily = 'helvetica';
    /* Ruta en donde se encuentra ubicada la imagen del logotipo institucional */
    $imageFile = K_PATH_IMAGES . "/logo.png";
    /* Ruta en donde se encuentra el cintillo o banner institucional */
    $bannerFile = K_PATH_IMAGES . "/cintillo.png";
    /* Estilos a implementar en el código QR a generar */
    $qrCodeStyle = [
        'border' => false,
        'padding' => 0,
        'fgcolor' => [0,0,0],
    ...
    /* Ruta de verificación del reporte mediante el código QR */
    $urlVerifyReport = 'www.tcpdf.org';
    /* Título a mostrar en el reporte */
    $reportTitle = 'Título del Reporte';
    /* Descripción o subtítulo del reporte */
    $reportDescription = 'Descripción breve del reporte';
    /* Estilos a implementar en las líneas de separación entre las secciones del reporte */
    ...
    /* Nombre del archivo bajo el cual se va a generar el reporte */
    $filename = 'my_file';
    /* Datos a mostrar en el cuerpo del reporte */
...
Route::get('clear-database', function () {
    ...
    if (Module::has('Asset') && Module::isEnabled('Asset')) {
