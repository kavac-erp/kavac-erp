...
class ReportRepository implements ReportInterface
{
    ...
    public function setConfig($params = [])
    {
        ...
        $this->subject = '';
        $this->titleIsHTML = $params['titleIsHTML'] ?? false;
        $this->subTitleIsHTML = $params['subTitleIsHTML'] ?? false;
    }
     ...
     * @param      string           $subTitleAlign Alineación del subtítulo del reporte. Los valores posibles son: L, C, R
     * @param      integer          $titleFontSize Tamaño del texto del título del reporte
     * @param      integer          $subTitleFontSize Tamaño del texto del subtítulo del reporte
     *
     * @return void
     */
    public function setHeader(
        ...
        $this->title = strip_tags($title ?? 'Reporte');
        $this->pdf->setHeaderCallback(function ($pdf) use ($params, $titleFontSize, $subTitleFontSize) {
            ...
            // $pdf->getPageWidth() - PDF_MARGIN_RIGHT - 113
            // $pdf->getPageWidth() - PDF_MARGIN_RIGHT - 130,

            // Configuración de la fuente para el título del reporte
            $pdf->SetFont($params->fontFamily, 'B', $titleFontSize);
            // Título del reporte
            $pdf->MultiCell(
                $pdf->getPageWidth() - 70,
                7,
            ...
            $pdf->SetFont($params->fontFamily, 'B', $subTitleFontSize);
